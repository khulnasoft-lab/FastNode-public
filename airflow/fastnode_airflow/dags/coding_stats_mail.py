...
from fastnode_airflow.common import files
...
TABLE_DAILY_ACTIVE_USERS = 'fastnode_daily_active_users' if utils.is_production() else 'fastnode_daily_active_users_dev'
...
fastnode_coding_stats_email_dag = DAG(
    'fastnode_coding_stats_mail',
...
approx_percentiles_op = AWSAthenaOperator(
    ...
    database=configs.DB_FASTNODE_METRICS,
    dag=fastnode_coding_stats_email_dag,
)
...
create_daily_active_users_op = AWSAthenaOperator(
    ...
    query='athena/coding_stats_mail/tables/fastnode_daily_active_users.sql',
    params={
        'table_name': TABLE_DAILY_ACTIVE_USERS,
