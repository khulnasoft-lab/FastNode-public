...
from fastnode_airflow.s3_utils import S3DeletePrefixOperator
...
for dataset in ['city']:
    maxmind_operator >> AWSAthenaOperator(
        ...
        query='''CREATE EXTERNAL TABLE fastnode_metrics.maxmind_{{params.dataset}}_names_{{ds_nodash}} (
            geoname_id string,
            locale_code string,
        ...
        query='''CREATE EXTERNAL TABLE fastnode_metrics.maxmind_ipv4_{{params.dataset}}_{{ds_nodash}} (
            network string,
            geoname_id string,
        ...
        query='''DROP TABLE fastnode_metrics.maxmind_{{params.dataset}}_ipv4''',
        output_location='s3://fastnode-metrics-test/athena-results/ddl',
        database='fastnode_metrics',
        dag=dag,
        params={
        ...
        query='''CREATE TABLE fastnode_metrics.maxmind_{{params.dataset}}_ipv4
        WITH (format='PARQUET',
              parquet_compression='SNAPPY',
              external_location = 's3://{{params.bucket}}/enrichment/maxmind/join/{{params.dataset}}/ipv4/')
        AS SELECT
            fastnode_metrics.maxmind_city_names_{{ds_nodash}}.country_iso_code country_iso_code,
            fastnode_metrics.maxmind_city_names_{{ds_nodash}}.country_name country_name,
            fastnode_metrics.maxmind_city_names_{{ds_nodash}}.subdivision_1_name subdivision_1_name,
            fastnode_metrics.maxmind_city_names_{{ds_nodash}}.city_name city_name,
            fastnode_metrics.maxmind_city_names_{{ds_nodash}}.time_zone time_zone,
            fastnode_metrics.maxmind_ipv4_city_{{ds_nodash}}.address address,
            fastnode_metrics.maxmind_ipv4_city_{{ds_nodash}}.mask mask
        FROM fastnode_metrics.maxmind_ipv4_city_{{ds_nodash}}
        JOIN fastnode_metrics.maxmind_city_names_{{ds_nodash}}
            ON fastnode_metrics.maxmind_ipv4_city_{{ds_nodash}}.geoname_id = fastnode_metrics.maxmind_city_names_{{ds_nodash}}.geoname_id
        ''',
        output_location='s3://fastnode-metrics-test/athena-results/ddl',
        database='fastnode_metrics',
        dag=dag,
        ...
        query='''DROP TABLE fastnode_metrics.maxmind_ipv4_{{params.dataset}}_{{ds_nodash}}''',
        output_location='s3://fastnode-metrics-test/athena-results/ddl',
        database='fastnode_metrics',
        dag=dag,
        params={
        ...
        query='''DROP TABLE fastnode_metrics.maxmind_{{params.dataset}}_names_{{ds_nodash}}''',
        output_location='s3://fastnode-metrics-test/athena-results/ddl',
        database='fastnode_metrics',
        dag=dag,
        params={
