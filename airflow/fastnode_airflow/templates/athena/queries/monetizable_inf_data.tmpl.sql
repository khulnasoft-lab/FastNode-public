...
AS WITH
  ...
  status AS (
    SELECT
      fastnode_status_normalized.userid,
    ...
    LEFT OUTER JOIN monetizable_scores ON fastnode_status_normalized.userid = monetizable_scores.userid
    WHERE
      ...
      AND fastnode_status_normalized.userid IS NOT NULL
      AND fastnode_status_normalized.userid != '0'
