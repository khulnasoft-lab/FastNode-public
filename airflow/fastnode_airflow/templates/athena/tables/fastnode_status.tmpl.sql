CREATE EXTERNAL TABLE `fastnode_status`(
...
LOCATION
  's3://fastnode-metrics/firehose/fastnode_status'
TBLPROPERTIES (
  ...
  'storage.location.template'='s3://fastnode-metrics/firehose/fastnode_status/${prefix}'
)