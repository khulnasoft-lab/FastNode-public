CREATE EXTERNAL TABLE `fastnode_status_normalized`(
...
STORED AS PARQUET
LOCATION 's3://fastnode-metrics/athena/fastnode_status_normalized/'
TBLPROPERTIES (
  ...
  'storage.location.template'='s3://fastnode-metrics/athena/fastnode_status_normalized/year=${year}/month=${month}/day=${day}/hour=${hour}'
);
