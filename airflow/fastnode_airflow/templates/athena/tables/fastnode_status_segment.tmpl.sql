CREATE EXTERNAL TABLE `fastnode_status_segment`(
...
LOCATION
  's3://fastnode-metrics/segment-logs/XXXXXXX'
TBLPROPERTIES (
  'projection.enabled'='true',
  'projection.prefix.interval'='XXXXXXX',
  'projection.prefix.range'='XXXXXXX,XXXXXXX',
  'projection.prefix.type'='integer',
  'storage.location.template'='s3://fastnode-metrics/segment-logs/XXXXXXX/${prefix}'
)
