...
func buildArgumentSample(arg *pythonast.Argument, funcSym pythonresource.Symbol,
	...
	if spec != nil {
		...
		if !pythonast.IsNil(arg.Name) {
			...
			// This cast should be safe but cf ISSUE 7528 (https://github.com/khulnasoft-lab/fastnode/issues/7528)
...
func main() {
	args := pipelineArguments{
		Filename: "/var/fastnode/../notebooks/literal_analysis/literalsCompSample_all.json",
	}
