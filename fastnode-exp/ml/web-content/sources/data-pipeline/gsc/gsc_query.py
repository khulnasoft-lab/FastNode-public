...
FASTNODE_ADDR = "https://khulnasoft.com/"
...
def list_pages(start_date, end_date, output_file, service):
    ...
    try:
        while True:
            ...
            i += 1
            response = execute_request(service, FASTNODE_ADDR, request)
...
def get_most_frequent_queries(service, start_date, end_date, outpath, only_usa = False, only_examples=True,
    ...
    """
    Extract all the most frequent queries leading to Fastnode website
