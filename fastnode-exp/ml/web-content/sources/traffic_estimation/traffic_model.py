...
class TrafficEstimator(object):
    ...
    def predict_volume(self):
        self.moz_data["fastnode_predicted_impressions"] = self.model.predict(self.moz_data[self.features])
        predicted_impressions = self.moz_data.groupby("URL").fastnode_predicted_impressions.sum()
