...
FASTNODE_TELEMETRY_ES = {
    'host': "https://search-fastnode-telemetry-dev-3-"
...
def build_client():
    ...
    awsauth = AWS4Auth(credentials.access_key,
                       ...
                       FASTNODE_TELEMETRY_ES['region'],
                       'es')

    es_client = Elasticsearch(
        hosts=[FASTNODE_TELEMETRY_ES['host']],
        http_auth=awsauth,
        use_ssl=True,
        verify_certs=True,
