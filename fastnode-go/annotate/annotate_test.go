...
var pythonOptions = Options{
	...
	DockerImage: "khulnasoft-lab/pythonsandbox",
}
...
eee`
	...
	lines := []string{
		`[[FASTNODE[[LINE 1]]FASTNODE]]`,
		`[[FASTNODE[[SHOW {"type": "plaintext", "expression": "a", "value": "123"}]]FASTNODE]]`,
		`[[FASTNODE[[LINE 3]]FASTNODE]]`,
		`[[FASTNODE[[SHOW {"type": "plaintext", "expression": "a", "value": "123"}]]FASTNODE]]`,
	}
...
func TestImageAnnotationInline(t *testing.T) {
	...
	stdout := `[[FASTNODE[[SHOW {"type": "image", "line": 0, "path": "somedir/image.png", "data": "aW1hZ2Vjb250ZW50cw=="}]]FASTNODE]]
`
...
func TestImageAnnotationOutOfLine(t *testing.T) {
	...
	stdout := `[[FASTNODE[[LINE 2]]FASTNODE]]
123[[FASTNODE[[SHOW {"type": "image", "path": "somedir/image.png", "data": "aW1hZ2Vjb250ZW50cw=="}]]FASTNODE]]
`
