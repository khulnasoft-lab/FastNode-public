...
// FastnodedEventer provides methods which are called after an according change in fastnoded application status
type FastnodedEventer interface {
	FastnodedInitialized()
	FastnodedUninitialized()
}
