...
func TestImplements(t *testing.T, obj interface{}, expected Implements) {
	...
	_, ok = obj.(FastnodedEventer)
	require.Equalf(t, expected.FastnodedEventer, ok, "unexpected implementation mismatch for component.FastnodedEventer is %s", c.Name())
