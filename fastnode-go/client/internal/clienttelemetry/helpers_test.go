...
func Test_Track(t *testing.T) {
	...
	FastnodeTelemetry("test", map[string]interface{}{
		"testprop": "testvalue",
	})
...
func Test_Deferred(t *testing.T) {
	...
	SetUserIDs(nil)
	FastnodeTelemetry("test 1", map[string]interface{}{
		"testprop": "testvalue",
	})
	...
	FastnodeTelemetry("test 2", map[string]interface{}{
		"testprop": "testvalue",
	})
	require.Equal(t, 1, len(mock.Tracked()))
	...
	FastnodeTelemetry("test 3", map[string]interface{}{
		"testprop": "testvalue",
	})
