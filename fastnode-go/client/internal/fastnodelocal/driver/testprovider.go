...
func (t *TestProvider) Driver(ctx fastnodectx.Context, filename, editor, state string) (*State, bool) {
	ctx.CheckAbort()
...
func (t *TestProvider) DriverFromContent(ctx fastnodectx.Context, filename, editor, content string, cursor int) *State {
	ctx.CheckAbort()
...
func (t *TestProvider) LatestDriver(ctx fastnodectx.Context, unixFilepath string) *python.UnifiedDriver {
	return nil
}
