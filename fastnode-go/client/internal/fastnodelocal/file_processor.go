...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/unsupported"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/localcode"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/proto"
...
func (f *fileProcessor) Driver(ctx fastnodectx.Context, filename, editor, state string) (*driver.State, bool) {
	ctx.CheckAbort()
...
func (f *fileProcessor) DriverFromContent(ctx fastnodectx.Context, filename, editor, content string, cursor int) *driver.State {
	ctx.CheckAbort()
...
func (f *fileProcessor) LatestDriver(ctx fastnodectx.Context, unixFilepath string) *python.UnifiedDriver {
	ctx.CheckAbort()
...
func (f *fileProcessor) fileDriverFromContent(ctx fastnodectx.Context, filename, source, content string, cursor int) *fileDriver {
	ctx.CheckAbort()
...
func (f *fileProcessor) handleEvent(ctx fastnodectx.Context, evt *event.Event) (*eventResponse, error) {
	ctx.CheckAbort()
...
func (f *fileProcessor) newFileDriver(filename string) *fileDriver {
	...
	switch {
	case f.testing:
		// sleep to make tests work on Windows, see https://github.com/khulnasoft-lab/fastnode/pull/6389#issuecomment-428929161
