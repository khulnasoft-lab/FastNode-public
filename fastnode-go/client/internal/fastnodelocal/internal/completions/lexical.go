...
func (m *Manager) lexicalCompletions(ctx fastnodectx.Context, req data.APIRequest, metricFn data.EngineMetricsCallback) data.APIResponse {
...
// Not warming up lexical models for now https://github.com/khulnasoft-lab/fastnode/issues/10070
...
func (m *Manager) handleLexicalEvents(evt *event.Event) {
	...
	m.lexicalapi.Edit(fastnodectx.Background(), compOpts, req, nil)
}
