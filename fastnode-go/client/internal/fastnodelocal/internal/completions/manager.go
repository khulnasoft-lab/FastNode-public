...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/client/internal/conversion/listener"
...
// Initialize is called by the fastnodelocal.Manager component
...
// Terminate is called by the fastnodelocal.Manager component
func (m *Manager) Terminate() {
	m.cancel()
}

// RegisterHandlers is called by the fastnodelocal.Manager component
...
// ProcessedEvent is called by the fastnodelocal.Manager component
...
// ToggleRemote swaps out the current models based on changes to the Fastnode Server setting.
...
type completionsFunc func(ctx fastnodectx.Context, req data.APIRequest, metricFn data.EngineMetricsCallback) data.APIResponse
...
func (m *Manager) supportsCompletionSelected(editor data.Editor, editorVersion, pluginVersion string) bool {
	if plugVer, err := version.NewVersion(pluginVersion); err == nil {
		...
		case data.IntelliJEditor:
			// https://github.com/khulnasoft-lab/intellij-plugin-private/commit/a74e30d8ecb96b3449e08e1f5b1b81ae75694cd1
		...
		case data.VSCodeEditor:
			// https://github.com/khulnasoft-lab/vscode-plugin/commit/07194a483ac81791ced2a74b66e79c188c01210d
