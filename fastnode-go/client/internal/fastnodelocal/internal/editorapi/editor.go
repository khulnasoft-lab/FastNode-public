...
import (
	...
	backend_editorapi "github.com/khulnasoft-lab/fastnode/fastnode-go/lang/editorapi"
...
func (m *Manager) handleEditor(w http.ResponseWriter, r *http.Request) {
	...
	/* Removed for now due to https://github.com/khulnasoft-lab/fastnode/issues/11796
