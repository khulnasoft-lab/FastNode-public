...
func Test_RequestingArtifact(t *testing.T) {
	...
	builder := func(t *testing.T) localcode.BuilderFunc {
		return func(_ fastnodectx.Context, params localcode.BuilderParams) (*localcode.BuilderResult, error) {
			...
			children, err := fs.GetChildren(fastnodectx.Background(), path.Dir(req))
...
func (t *testFilesystem) FastnodeDir() string {
	return "/"
}
...
func (t *testFilesystem) GetChildren(ctx fastnodectx.Context, root string) ([]*localfiles.File, error) {
