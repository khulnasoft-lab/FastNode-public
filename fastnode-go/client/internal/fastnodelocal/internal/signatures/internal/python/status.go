...
var (
	section = status.NewSection("client/internal/fastnodelocal/internal/signatures/python")
...
var (
	signatureStatus = status.NewSection("client/internal/fastnodelocal/internal/signatures/python Signature Tracking")
