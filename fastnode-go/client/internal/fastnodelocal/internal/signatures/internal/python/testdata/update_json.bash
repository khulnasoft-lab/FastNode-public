...
# Requirements:
# - Fastnode running on localhost:46624
# - The 1st argument must be a file in a whitelisted directory, it will be overwritten with temporary data to let Fastnode work on it
