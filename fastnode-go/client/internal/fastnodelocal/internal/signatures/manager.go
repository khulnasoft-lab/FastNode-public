...
import (
	...
	pythonsig "github.com/khulnasoft-lab/fastnode/fastnode-go/client/internal/fastnodelocal/internal/signatures/internal/python"
...
type Provider interface {
	Callee(ctx fastnodectx.Context, cursor int64) (python.CalleeResult, int, error)
}
...
func (m *Manager) handleSignatures(w http.ResponseWriter, r *http.Request) {
	...
	err = fastnodectx.FromContext(r.Context(), func(ctx fastnodectx.Context) (err error) {
...
func (m *Manager) callee(ctx fastnodectx.Context, r calleeRequest) (*editorapi.CalleeResponse, error) {
	ctx.CheckAbort()
