...
type RemoteControl struct {
	...
	client         *mockserver.FastnodedClient
	t              *testing.T
}
...
func NewEditorRemoteControl(editor string, testEnv *clientapp.TestEnvironment, t *testing.T) *RemoteControl {
	return &RemoteControl{
		...
		BytesOffset: 0,
		testEnv:     testEnv,
		client:      testEnv.FastnodedClient,
		t:           t,
	}
}
...
// SendFocusEvent sends a focus event to fastnoded
