...
// Manager is a component to monitor the network network of fastnoded
type Manager struct {
	client       *http.Client
	components   *component.Manager
	online       int64
	fastnodedOnline  int64
	forceOffline bool
...
func (m *Manager) RegisterHandlers(mux *mux.Router) {
	...
	mux.HandleFunc("/clientapi/fastnoded_online", m.returnTrue)
}
...
// it sets the value of fastnodedOnline to true when called
func (m *Manager) FastnodedInitialized() {
	atomic.StoreInt64(&m.fastnodedOnline, 1)
}

// FastnodedUninitialized implements interface FastnodedEventer
// it sets the value of fastnodedOnline to false when called
func (m *Manager) FastnodedUninitialized() {
	atomic.StoreInt64(&m.fastnodedOnline, 0)
}
...
// FastnodedOnline implements interface component.FastnodedOnline
func (m *Manager) FastnodedOnline() bool {
	return atomic.LoadInt64(&m.fastnodedOnline) == int64(1)
}
