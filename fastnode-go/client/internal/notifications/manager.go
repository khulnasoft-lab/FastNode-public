...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-golib/conversion"
	cohorts "github.com/khulnasoft-lab/fastnode/fastnode-golib/conversion"
...
func (m *Manager) Initialize(opts component.InitializerOptions) {
	...
	fp := filepath.Join(opts.Platform.FastnodeRoot, "notifications")
...
func (m *Manager) ProcessedEvent(event *event.Event, editorEvent *component.EditorEvent) {
	...
	// don't show again until Fastnode is restarted
