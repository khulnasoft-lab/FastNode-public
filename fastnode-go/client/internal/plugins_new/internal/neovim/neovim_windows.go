...
import (
	...
	validator "github.com/khulnasoft-lab/fastnode/fastnode-go/client/internal/plugins_new/internal/vim"

	"github.com/khulnasoft-lab/fastnode/fastnode-go/client/internal/plugins/vim"
...
func (n *windowsNeovim) Uninstall(ctx context.Context, editorPath string) error {
	...
	// Remove %LOCALAPPDATA%/nvim/pack/fastnode/ and its subdirectories.
