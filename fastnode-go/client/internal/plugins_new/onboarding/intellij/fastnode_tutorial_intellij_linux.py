...
""" PART 0: BEFORE WE START ====================================================
    ...
    Fastnode's PyCharm plugin will by default try to start the Fastnode backend when
    ...
    Look for the Fastnode icon in the bottom right corner of PyCharm's status bar —
...
""" PART 3: INSTANT DOCUMENTATION ==============================================
    ...
    Fastnode can also show you documentation for the symbols in your code. You can
    use the action "Fastnode: Docs at cursor" to view documentation for the symbol
    under your cursor.
"""
...
# • Press ctrl+shift+a.
# • Run the action "Fastnode: Docs at cursor".
...
""" That's it!
    ...
    'Fastnode: Python Tutorial'.

    Learn more about Fastnode at our help page:
