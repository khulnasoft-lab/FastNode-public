...
""" Fastnode is your Python programming copilot. Fastnode will try to show you the
...
""" PART 0: BEFORE WE START ===================================================
    ...
    Spyder will by default try to start the Fastnode backend when the editor first
    starts. You can change this behavior by opening settings, clicking on
    "Completion and linting", "Advanced", and then changing Fastnode's "Start Fastnode
    Engine on editor startup" setting.

    Look for the Fastnode indicator in the bottom left corner of Spyder's status
...
#
# Fastnode analyzes data analysis libraries such as matplotlib much more
# intelligently than Spyder's builtin language server. As a result, you will
# see many more completions when coding with Fastnode.
...
# • Remember to press ctrl+space if autocompletions aren't on.
# • Typing the same code without Fastnode enabled would result in no completions
...
""" PART 3: INSTANT DOCUMENTATION =============================================
    ...
    Fastnode can also show you documentation for the symbols in your code in the
    Copilot application.

    To do so, open Fastnode's Copilot, ensure that the button labeled "Click for
    docs to follow cursor" in the upper right corner is enabled, and then
    simply position your cursor over a symbol.

    To open Fastnode's Copilot, visit the URL fastnode://home in your browser.
"""
...
# • Documentation for the Figure class will be shown in Fastnode's Copilot.
...
""" That's it!
    ...
    you code. You can learn more about Fastnode's Spyder integration at our help
    page:

    https://help.khulnasoft.com/category/89-spyder-integration
