...
// PluginInstallerLocal installs the plugin for the editor at the given path when Fastnode Local is enabled.
type PluginInstallerLocal func(string) error

// PluginUninstallerLocal uninstalls the plugin for the editor at the given path when Fastnode Local is enabled.
