...
func defaultTestSettings() testSettings {
	return map[string]string{
		ServerKey:                      "https://test-2.khulnasoft.com",
		StatusIconKey:                  "true",
...
func defaultSettings() testSettings {
	return map[string]string{
		...
		FastnodeServer:                     *specs[FastnodeServer].defaultValue,
...
func TestRevert(t *testing.T) {
	...
	resp := requireResponse(t, ts, "PUT", ServerKey, "https://test-4.khulnasoft.com")
...
func TestServer(t *testing.T) {
	...
	url := "https://test-4.khulnasoft.com"
...
func TestServerInvalid(t *testing.T) {
	...
	resp := requireResponse(t, ts, "PUT", ServerKey, "/http://test.khulnasoft.com")
	defer resp.Body.Close()
...
func TestServerMethod(t *testing.T) {
	...
	server = "https://test-4.khulnasoft.com"
