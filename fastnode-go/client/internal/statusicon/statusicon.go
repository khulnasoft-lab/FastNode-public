...
var serverURLs = []string{
	...
	"https://test-0.khulnasoft.com/",
	"https://test-1.khulnasoft.com/",
	"https://test-2.khulnasoft.com/",
	"https://test-3.khulnasoft.com/",
	"https://test-4.khulnasoft.com/",
	"https://test-5.khulnasoft.com/",
	"https://test-6.khulnasoft.com/",
	"https://test-7.khulnasoft.com/",
	"https://test-8.khulnasoft.com/",
	"https://192.168.30.10/",
	"http://127.0.0.1:9090/",
}
...
type UI struct {
	fastnodedURL *url.URL // still in use by statusicon_linux.go
...
func (ui *UI) Initialize(opts component.InitializerOptions) {
	ui.fastnodedURL = opts.FastnodedURL
...
// Start runs the systray loop and passes the Fastnode client to onReady
func (ui *UI) start() {
...
func (ui *UI) onReady(h systray.Handle) {
	...
	switch runtime.GOOS {
	case "windows":
		ui.icon = MustAsset("asset/fastnode_monochrome.ico")
	case "linux":
		ui.icon = MustAsset("asset/fastnode_light.png")
	default:
		ui.icon = MustAsset("asset/fastnode_monochrome.tiff")
	}
	...
	// Quit
	systray.AddMenuItem("Quit Fastnode", "", ui.onQuitClicked)
