...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/client/sysidle"
...
// updater on platforms where the updater is external to fastnoded (i.e. windows and linux).
// If it returns 200 then the updater will restart and update fastnoded.
