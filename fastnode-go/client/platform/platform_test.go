...
func Test_DebugFile(t *testing.T) {
	tempDir, err := ioutil.TempDir(os.TempDir(), "fastnode")
...
func Test_Version(t *testing.T) {
	...
	require.NoError(t, err)
	defer os.RemoveAll(p.FastnodeRoot)
...
func Test_InstallID(t *testing.T) {
	...
	require.NoError(t, err, "The install id must be saved into $FASTNODEROOT/installid when it's generated")
