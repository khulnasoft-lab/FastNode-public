...
// this state. This logic is meant to enable restarting of the sidebar in the case Fastnode
// was shutdown and restarted via update.
func SetRestartIfPreviouslyVisible(val bool) error {
	return c.SetWasVisible(val)
}

// StartIfPreviouslyVisible starts the sidebar if the sidebar was running when Fastnode was shut down.
