...
func (d devDarwinController) Start() error {
	...
	app := filepath.Join(gopath, "src/github.com/khulnasoft-lab/fastnode/sidebar/dist/mac/Fastnode.app")
...
func (d devDarwinController) Notify(id string) error {
	...
	app := filepath.Join(gopath, "src/github.com/khulnasoft-lab/fastnode/sidebar/dist/mac/Fastnode.app/Contents/MacOS/Fastnode")
