...
var (
	addr = mail.Address{
		Name:    "Fastnode Engineering",
		Address: "eng@khulnasoft.com",
	}
	hostport = os.Getenv("FASTNODE_ENG_EMAIL_SMTP_HOSTPORT")
	user     = os.Getenv("FASTNODE_ENG_EMAIL_USERNAME")
	password = os.Getenv("FASTNODE_ENG_EMAIL_PASSWORD")
)
...
<head>
<title>Fastnode Alpha Users</title>
<style type="text/css">
body {
...
<body>
<h1>Fastnode Alpha Users ({{.Today}})</h1>
