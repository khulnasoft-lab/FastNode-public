...
func bundleCmd() *cobra.Command {
	...
	var bundleKhulnasoft_labPaths *[]string
	var bundleFastnodeML *bool
	...
	bundleCmd := cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			conf := bundleConfig{
				...
				Khulnasoft_labPaths:  *bundleKhulnasoft_labPaths,
				BundleFastnodeML: *bundleFastnodeML,
	...
	bundleKhulnasoft_labPaths = bundleCmd.Flags().StringSlice("khulnasoft-lab-path", nil,
		"List of paths relative to khulnasoft-lab root that should be included in the bundle")

	bundleFastnodeML = bundleCmd.Flags().Bool("fastnode-ml", false,
		"include fastnode_ml code and virtualenv")
