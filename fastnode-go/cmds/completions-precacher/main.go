...
func main() {
	...
	// 			resp, expected, err := websandbox.XXXXXXXCompletions(fastnodectx.Background(), services, payload)
	// 			// conditions to retry
	// 			switch {
	// 			case err != nil:
	...
	// 			}
	// 		default:
	// 			resp, expected, err := websandbox.Completions(fastnodectx.Background(), services, payload)
	// 			// conditions to retry
	// 			switch {
	// 			case err != nil:
	// 				log.Printf("Error getting completions: %v", err)
