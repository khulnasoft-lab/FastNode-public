...
from tracelib import macros, fastnode_trace, get_all_traced_ast_reprs
...
# test fastnode_trace on expressions rather than code blocks
fastnode_trace[repr([1, 1 + 1, 3])]
fastnode_trace[str(1)]
fastnode_trace[[1, 2]]
fastnode_trace[(2, 3, 1 + 5)]
fastnode_trace[int("5")]
fastnode_trace[re.compile('.*')]
fastnode_trace[{1: 2}[1]]
