...
import (
	...
	stripefastnode "github.com/khulnasoft-lab/fastnode/fastnode-golib/stripe"
...
type checkoutApp struct {
	...
	plans     stripefastnode.Plans
}

func buildApp(plans stripefastnode.Plans, users *community.UserManager) checkoutApp {
...
func (a checkoutApp) handleSuccess(w http.ResponseWriter, r *http.Request) {
	...
	a.renderRootTemplate(w, "Congrats, you successfully paid for Fastnode PRO")
}
