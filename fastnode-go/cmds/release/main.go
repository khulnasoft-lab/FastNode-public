...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/release"
...
// This is duplicated in services/release.khulnasoft.com/main.go for devops
var cmdServer = &cmd{
	name:   "server",
	argNum: 0,
...
var cmdLocalServer = &cmd{
	...
	example: "release localserver mac $GOPATH/src/github.com/khulnasoft-lab/fastnode/osx",
	run: func(manager release.MetadataManager, args []string) {
		var platform release.Platform
		switch args[0] {
		case "mac":
