...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/answers"
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/seo"
...
func init() {
	...
	url, err = url.Parse("https://www.khulnasoft.com/")
	if err != nil {
		panic(err)
	}
	sitemapRoot = *url

	url, err = url.Parse("https://www.khulnasoft.com/python/docs")
	if err != nil {
		panic(err)
	}
	docsRoot = *url

	url, err = url.Parse("https://www.khulnasoft.com/python/examples")
	if err != nil {
		panic(err)
	}
	examplesRoot = *url

	url, err = url.Parse("https://www.khulnasoft.com/python/answers")
	if err != nil {
		panic(err)
	}
	answersRoot = *url
...
func main() {
	...
	flag.StringVar(&bucket, "bucket", "fastnode-data", "sitemap s3 upload bucket")
	flag.Parse()
