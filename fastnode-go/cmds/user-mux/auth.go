...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/hmacutil"
)
...
func (u *userAuthMidware) ServeHTTP(w http.ResponseWriter, r *http.Request, next http.HandlerFunc) {
	// Change this to khulnasoft.com / www.khulnasoft.com when going live
	if r.Host == "test.khulnasoft.com" {
	...
	// Set Fastnode-Region header for all responses
	if region != "" {
