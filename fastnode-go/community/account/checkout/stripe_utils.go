...
func createSubscription(
	...
	var stripePlanID fastnodeStripe.PlanID
	...
	params.AddMetadata("fastnode_pro_subscription_request", truncatedRequest)

	params.AddMetadata("fastnode_user_id", fmt.Sprint(subscriptionData.UserID))
	params.Items[0].AddMetadata("fastnode_user_id", fmt.Sprint(subscriptionData.UserID))
