...
// PlanResponse for an account, used in client.internal.fastnode.client.handlePlan
...
type PlanResponse struct {
	...
	// StartedFastnodeProTrial is true if the user has already started their fastnode pro trial_days_remaining
	StartedFastnodeProTrial bool `json:"started_fastnode_pro_trial"`
