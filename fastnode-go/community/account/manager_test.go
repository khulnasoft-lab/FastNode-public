...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/web"
...
func TestManager_AutomaticEducationalLicense(t *testing.T) {
	...
	eduUser, _ := requireCreateUserSession(t, mgr, "fastnode-student@valid-school.com")
	...
	regularUser, _ := requireCreateUserSession(t, mgr, "fastnode-user@not-a-school.com")
