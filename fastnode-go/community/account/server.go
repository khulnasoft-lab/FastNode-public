...
func (s *Server) SetupRoutes(router *mux.Router) {
	...
	// invite to flywithfastnode slack
	...
	router.HandleFunc("/fastnode-google{rest:.*}", http.StripPrefix("/api/account/fastnode-google", s.gaProxy).ServeHTTP)
...
// handleSlackInvite handles inviting an email address to the flywithfastnode slack channel
