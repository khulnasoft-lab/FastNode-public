...
// to get an email to download Fastnode on their computer
...
// TrackUserMobileDownload is called when a user buys a Fastnode Pro subscription.
...
// TrackStartTrial is called when a user strats his Fastnode Pro trial.
...
// TrackProPurchase is called when a user buys a Fastnode Pro subscription.
...
// TrackProPaidTrialStarted is called when a user buys a Fastnode Pro subscription.
...
// TrackProCancel is called when a user cancels his Fastnode Pro subscription.
