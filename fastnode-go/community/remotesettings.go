...
const (
	// FastnodeProEnabled is the flag used to activate Fastnode Pro licensing system
	FastnodeProEnabled = "fastnode_pro_enabled"
)

var remoteSettingsValue = map[string]string{
	"fastnode_pro_enabled": "true",
}

var remoteSettingsList = []string{FastnodeProEnabled}
