...
func (s *SettingsManager) Load() error {
	s.settings = settings{
		EmailHostPort:      os.Getenv("FASTNODE_ENG_EMAIL_SMTP_HOSTPORT"),
		EmailUserName:      os.Getenv("FASTNODE_ENG_EMAIL_USERNAME"),
		EmailPassword:      os.Getenv("FASTNODE_ENG_EMAIL_PASSWORD"),
		EmailSenderName:    os.Getenv("FASTNODE_ENG_EMAIL_SENDER_NAME"),
		EmailSenderAddress: os.Getenv("FASTNODE_ENG_EMAIL_SENDER_ADDRESS"),
	}
	return nil
}
