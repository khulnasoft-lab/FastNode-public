...
var (
	...
	defaultBcc = "invite-bcc@khulnasoft.com"
)
...
// Signup contains information about a signup to be invited to use Fastnode.
type Signup struct {
	ID        int64     `json:"-"`
	...
	Downloads []*Download `json:"-"` // timestamps when Fastnode was downloaded

	Unsubscribed bool `json:"unsubscribed" sql:"default:false"` // For e-mail communications
}

// Download contains a timestamp when a user downloaded Fastnode.
