...
const pathSwotTxt = "fastnode-go/community/student/cmds/updatedomains/swot.txt"
...
func main() {
	...
	path := fmt.Sprintf("s3://fastnode-data/swot-student-domains/domain-lists_%s.json.gz", time.Now().Format("2006-01-02T15:04:05"))
