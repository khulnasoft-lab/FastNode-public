...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/annotate"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/community"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/curation"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/curation/handlers"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/curation/titleparser"
...
func (a *App) handleUnifiedAuthor(w http.ResponseWriter, r *http.Request) {
	...
	// that start with `fastnode_interview`
	if user.Email == "curator_candidate@khulnasoft.com" && !strings.HasPrefix(pkg, "fastnode_interview") {
...
func (a *App) handlePackages(w http.ResponseWriter, r *http.Request) {
	...
	if user.Email == "curator_candidate@khulnasoft.com" {
		webutils.ReportNotFound(w, "page not found")
		return
	}
