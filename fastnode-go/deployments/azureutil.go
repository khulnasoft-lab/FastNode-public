...
var (
	// source of these values are fastnode-go/cmds/azure-deployments/regions.go (which is sourced from
	// terraform)
...
// fastnode-go/cmds/azure-deployments, along with all the necessarily utility functions, also slightly
// modified
