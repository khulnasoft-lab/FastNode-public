...
var (
	...
	khulnasoft-labPath    = filepath.Join(goPath, "src/github.com/khulnasoft-lab/fastnode")
	lexicalPath   = filepath.Join(khulnasoft-labPath, "fastnode-go/lang/lexical")
...
func readModelPaths() []string {
	...
	if language.Lexer == lang.JavaScript {
		modelPaths = append(modelPaths,
			"s3://fastnode-data/run-db/2020-07-20T03:38:09Z_lexical-model-experiments/out_javascript_prefix_suffix_context_1024_embedding_180_layer_4_head_6_vocab_20000_steps_50000_batch_70",
			"s3://fastnode-data/run-db/2020-02-05T20:25:06Z_lexical-model-experiments/out_javascript_lexical_context_512_embedding_180_layer_4_head_6_vocab_20000_steps_2000000_batch_5_slots_20",
		)
	}
	if lexicalv0.WebGroup.Equals(language) {
		modelPaths = append(modelPaths,
			"s3://fastnode-data/run-db/2020-09-29T03:48:57Z_lexical-model-experiments/out_text__javascript-jsx-vue-css-html-less-typescript-tsx_lexical_context_512_embedding_180_layer_4_head_6_vocab_13500_steps_25000_batch_160",
			"s3://fastnode-data/run-db/2020-10-07T18:29:44Z_lexical-model-experiments/out_text__javascript-jsx-vue-css-html-less-typescript-tsx_lexical_context_512_embedding_180_layer_4_head_6_vocab_13500_steps_25000_batch_160",
		)
	}
	if lexicalv0.JavaPlusPlusGroup.Equals(language) {
		modelPaths = append(modelPaths,
			"s3://fastnode-data/run-db/2020-10-08T05:09:31Z_lexical-model-experiments/out_text__java-scala-kotlin_lexical_context_512_embedding_180_layer_4_head_6_vocab_13500_steps_25000_batch_160",
		)
	}
	if lexicalv0.CStyleGroup.Equals(language) {
		modelPaths = append(modelPaths,
			"s3://fastnode-data/run-db/2020-10-09T05:43:16Z_lexical-model-experiments/out_text__c-cpp-objectivec-csharp_lexical_context_512_embedding_180_layer_4_head_6_vocab_20000_steps_25000_batch_160",
		)
	}
	if language.Lexer == lang.Text && language.Langs[0] == lang.Golang {
		modelPaths = append(modelPaths,
			"s3://fastnode-data/run-db/2020-09-15T21:49:44Z_lexical-model-experiments/out_text_lexical_context_1024_embedding_180_layer_4_head_6_vocab_13500_steps_25000_batch_80",
		)
	}
	if language.Lexer == lang.Golang {
		modelPaths = append(modelPaths,
			"s3://fastnode-data/run-db/2020-08-09T23:12:39Z_lexical-model-experiments/out_go_lexical_context_1024_embedding_180_layer_4_head_6_vocab_13500_steps_50000_batch_90",
		)
	}
	if language.Equals(lexicalv0.NewLangGroup(lang.Text, lang.Java)) {
		modelPaths = append(modelPaths,
			"s3://fastnode-data/run-db/2020-09-28T18:57:46Z_lexical-model-experiments/out_text__java_lexical_context_512_embedding_180_layer_4_head_6_vocab_13500_steps_25000_batch_160",
		)
	}

	if language.Lexer != lang.Text {
		path := fileutil.Join("s3://fastnode-local-pipelines/lexical-inspector/models", language.Name())
