...
func (a API) Complete(ctx fastnodectx.Context, opts CompleteOptions, req data.APIRequest, fd core.FileDriver, metricFn data.EngineMetricsCallback) data.APIResponse {
	return a.update(ctx, opts, req, fd, true, metricFn)
}

// Edit triggers the completions engine on the edit
func (a API) Edit(ctx fastnodectx.Context, opts CompleteOptions, req data.APIRequest, fd core.FileDriver) {
...
func (a API) update(ctx fastnodectx.Context, opts CompleteOptions, req data.APIRequest, fd core.FileDriver, requestCompletions bool, metricFn data.EngineMetricsCallback) data.APIResponse {
