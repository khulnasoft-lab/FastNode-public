...
func runTestCase(ctx fastnodectx.Context, t *testing.T, tc corpustests.TestCase, options api.CompleteOptions) {
	compls := requireCompletions(ctx, t, tc, options)
	corpustests.RunTestCase(ctx, t, tc, compls)
}

func requireCompletions(ctx fastnodectx.Context, t *testing.T, tc corpustests.TestCase, options api.CompleteOptions) []data.RCompletion {
