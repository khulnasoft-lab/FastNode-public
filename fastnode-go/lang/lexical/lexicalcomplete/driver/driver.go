...
func (d Driver) getInputs(ctx fastnodectx.Context, global lexicalproviders.Global, b, root data.SelectedBuffer) (lexicalproviders.Inputs, error) {
	ctx.CheckAbort()
...
func (d Driver) prepareWorkLocked(ctx fastnodectx.Context, work workItem) func() error {
	...
	workFn, cancel := ctx.ClosureWithCancel(func(ctx fastnodectx.Context) error {
		...
		return work.Provider.Provide(ctx, global, inps, func(ctx fastnodectx.Context, source data.SelectedBuffer, compl lexicalproviders.MetaCompletion) {
			d.cond.L.Lock()
			defer d.cond.L.Unlock()
			ctx.CheckAbort()
...
func (d Driver) Update(ctx fastnodectx.Context, opts Options, global lexicalproviders.Global, buf data.SelectedBuffer, requestCompletions bool, metricFn data.EngineMetricsCallback) ([]data.NRCompletion, error) {
...
func (d Driver) updateBlocking(ctx fastnodectx.Context, opts Options, global lexicalproviders.Global, buf data.SelectedBuffer, metricFn data.EngineMetricsCallback) ([]data.NRCompletion, error) {
...
func (d Driver) updateNonBlocking(ctx fastnodectx.Context, opts Options, global lexicalproviders.Global, buf data.SelectedBuffer) ([]data.NRCompletion, error) {
	err := func() error {
		d.cond.L.Lock()
		defer d.cond.L.Unlock()
