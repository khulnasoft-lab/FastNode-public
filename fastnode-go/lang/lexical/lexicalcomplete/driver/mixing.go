...
type MixOptions struct {
	...
	// that insert the wrong thing, see: https://github.com/khulnasoft-lab/fastnode/issues/11055
	NoDollarSignDotCompletions bool

	// NoDollarSignCompletions is a hack to disable completions that contain $ for editors
	// that insert the wrong thing, see: https://github.com/khulnasoft-lab/fastnode/issues/11054
...
func (s *scheduler) Mix(ctx fastnodectx.Context, opts MixOptions, g lexicalproviders.Global, root data.SelectedBuffer) []data.NRCompletion {
	ctx.CheckAbort()
...
func (m *Mixer) Mix(ctx fastnodectx.Context, g lexicalproviders.Global) []data.NRCompletion {
