...
func (m *Mixer) makeCompletion(ctx fastnodectx.Context, g lexicalproviders.Global, c completion) data.RCompletion {
	ctx.CheckAbort()
...
func (m *Mixer) renderCompletions(ctx fastnodectx.Context, g lexicalproviders.Global, completions *CompletionTree) []data.NRCompletion {
