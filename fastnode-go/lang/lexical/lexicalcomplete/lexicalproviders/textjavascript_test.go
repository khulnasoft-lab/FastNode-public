...
render(
  <Provider store={store}>
	...
	// SEE: https://fastnode.quip.com/c0WgAlHPJtoa/Lexical-all-languages#ZYEACAlNJX2
	// require.True(t, res.containsRoot(data.Completion{
...
// TODO: turn back on once https://fastnode.quip.com/c0WgAlHPJtoa/Lexical-all-languages#ZYEACAlNJX2 is resolved
