...
var LocalModelOptions = ModelOptions{
	TextMiscGroup: ModelConfig{
		...
		ModelPath: "s3://fastnode-data/run-db/2020-10-21T15:48:52Z_lexical-model-experiments/out_text__python-go-php-ruby-bash_lexical_context_512_embedding_180_layer_4_head_6_vocab_13500_steps_25000_batch_160",
	},
	TextWebGroup: ModelConfig{
		Type:      TFPredictorType,
		Lang:      lexicalv0.WebGroup,
		ModelPath: "s3://fastnode-data/run-db/2020-10-07T18:29:44Z_lexical-model-experiments/out_text__javascript-jsx-vue-css-html-less-typescript-tsx_lexical_context_512_embedding_180_layer_4_head_6_vocab_13500_steps_25000_batch_160",
	},
	TextJavaGroup: ModelConfig{
		Type:      TFPredictorType,
		Lang:      lexicalv0.JavaPlusPlusGroup,
		ModelPath: "s3://fastnode-data/run-db/2020-10-08T05:09:31Z_lexical-model-experiments/out_text__java-scala-kotlin_lexical_context_512_embedding_180_layer_4_head_6_vocab_13500_steps_25000_batch_160",
	},
	TextCGroup: ModelConfig{
		Type:      TFPredictorType,
		Lang:      lexicalv0.CStyleGroup,
		ModelPath: "s3://fastnode-data/run-db/2020-10-09T05:43:16Z_lexical-model-experiments/out_text__c-cpp-objectivec-csharp_lexical_context_512_embedding_180_layer_4_head_6_vocab_20000_steps_25000_batch_160",
	},
}

// DefaultRemoteHost is the default Fastnode Cloud Server host
var DefaultRemoteHost = "tfserving.khulnasoft.com:8085"
...
func (opts ModelOptions) WithRemoteModels(host string) ModelOptions {
	parsedHost, err := fastnodeserver.ParseFastnodeServerURL(host)
