...
const DefaultPath = "s3://fastnode-data/fastnode-answers/2020-03-27T18:44:45.json.gz"
...
type Index struct {
	...
	// The keys are SEO-normalized paths (as per the fastnode-go/lang/python/seo package).
