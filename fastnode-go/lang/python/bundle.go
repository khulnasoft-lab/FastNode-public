...
func newValueBundle(ctx fastnodectx.Context, val pythontype.Value, idx indexBundle) valueBundle {
...
func (vb valueBundle) valueType(ctx fastnodectx.Context) valueBundle {
	ctx.CheckAbort()
...
func (vb valueBundle) valueModule(ctx fastnodectx.Context) valueBundle {
	ctx.CheckAbort()
...
func (vb valueBundle) memberSymbol(ctx fastnodectx.Context, v pythontype.Value, attr string) symbolBundle {
	ctx.CheckAbort()
...
func (vb valueBundle) disjuncts(ctx fastnodectx.Context) []valueBundle {
	ctx.CheckAbort()
