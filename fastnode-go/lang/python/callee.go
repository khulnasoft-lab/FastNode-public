...
func GetCallee(ctx fastnodectx.Context, in CalleeInputs) CalleeResult {
	ctx.CheckAbort()
...
func FindCallExpr(ctx fastnodectx.Context, ast pythonast.Node, buf []byte, cursor int64) (expr *pythonast.CallExpr, outsideParens bool, inBadNode bool) {
	ctx.CheckAbort()
...
type calleeVisitor struct {
	...
	inBadNode *bool
	ctx       fastnodectx.Context // store here because no other way
}
