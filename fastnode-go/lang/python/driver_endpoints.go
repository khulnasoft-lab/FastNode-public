...
func wrapCtx(f func(fastnodectx.Context, http.ResponseWriter, *http.Request)) func(http.ResponseWriter, *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		// ignore any resulting error; if there is one, the request has timed out, so there's nothing to do
		_ = fastnodectx.FromContext(r.Context(), func(ctx fastnodectx.Context) error {
			f(ctx, w, r)
			return nil
		})
	}
...
func (s *DriverEndpoint) handleHover(ctx fastnodectx.Context, w http.ResponseWriter, r *http.Request) {
	ctx.CheckAbort()
...
func (s *DriverEndpoint) handleCallee(ctx fastnodectx.Context, w http.ResponseWriter, r *http.Request) {
	ctx.CheckAbort()
