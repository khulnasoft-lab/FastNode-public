...
func (e *EditorEndpoint) ValueReport(ctx fastnodectx.Context, id string) (*editorapi.ReportResponse, int, error) {
	ctx.CheckAbort()
...
func (e *EditorEndpoint) ValueMembers(ctx fastnodectx.Context, id string, offset, limit int) (*editorapi.MembersResponse, int, error) {
	ctx.CheckAbort()
...
func (e *EditorEndpoint) ValueMembersExt(ctx fastnodectx.Context, id string, offset, limit int) (*editorapi.MembersExtResponse, int, error) {
	ctx.CheckAbort()
...
func (e *EditorEndpoint) SymbolReport(ctx fastnodectx.Context, id string) (*editorapi.ReportResponse, int, error) {
	ctx.CheckAbort()
...
func (e *EditorEndpoint) Search(ctx fastnodectx.Context, query string, offset, limit int) (*editorapi.SearchResults, int, error) {
	ctx.CheckAbort()
	...
	// InvertedIndex is nil in fastnode local. Return empty search results and set
...
func (e *EditorEndpoint) LocalSearch(ctx fastnodectx.Context, query string, offset, limit int) (*editorapi.SearchResults, int, error) {
	ctx.CheckAbort()
...
func (e *EditorEndpoint) symbolReportResponse(ctx fastnodectx.Context, id string) (*editorapi.ReportResponse, int, error) {
...
func (e *EditorEndpoint) membersResponse(ctx fastnodectx.Context, id string, off, num int) (*editorapi.MembersResponse, int, error) {
	vb, code, err := e.locateValue(ctx, id)
	if err != nil {
		return nil, code, err
	}
...
func (e *EditorEndpoint) membersExtResponse(ctx fastnodectx.Context, id string, off, num int) (*editorapi.MembersExtResponse, int, error) {
	vb, code, err := e.locateValue(ctx, id)
	if err != nil {
		return nil, code, err
	}
...
func (e *EditorEndpoint) locateValue(ctx fastnodectx.Context, id string) (valueBundle, int, error) {
	ctx.CheckAbort()
...
func (e *EditorEndpoint) locateSymbol(ctx fastnodectx.Context, id string) (symbolBundle, int, error) {
	ctx.CheckAbort()
