...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythoncuration"
...
// TODO(juan): nasty
func RenderSymbol(ctx fastnodectx.Context, rm pythonresource.Manager, namespace, referent pythontype.Value, ident string) *editorapi.Symbol {
...
func (s *editorServices) renderValue(ctx fastnodectx.Context, vb valueBundle) *editorapi.Value {
	ctx.CheckAbort()
...
func (s *editorServices) renderValueExt(ctx fastnodectx.Context, vb valueBundle) *editorapi.ValueExt {
	ctx.CheckAbort()
...
func (s *editorServices) renderUnion(ctx fastnodectx.Context, ub valueBundle) editorapi.Union {
	ctx.CheckAbort()
...
func (s *editorServices) renderUnionExt(ctx fastnodectx.Context, ub valueBundle) editorapi.UnionExt {
	ctx.CheckAbort()
...
func (s *editorServices) renderSymbolBase(ctx fastnodectx.Context, sb symbolBundle) editorapi.SymbolBase {
	ctx.CheckAbort()
...
func (s *editorServices) renderSymbol(ctx fastnodectx.Context, sb symbolBundle) *editorapi.Symbol {
	ctx.CheckAbort()
...
func (s *editorServices) renderMemberSymbol(ctx fastnodectx.Context, sb symbolBundle) *editorapi.Symbol {
	ctx.CheckAbort()
...
func (s *editorServices) renderMemberSymbolExt(ctx fastnodectx.Context, sb symbolBundle) *editorapi.SymbolExt {
	ctx.CheckAbort()
...
func (s *editorServices) renderValueReport(ctx fastnodectx.Context, vb valueBundle) *editorapi.Report {
	ctx.CheckAbort()
...
func (s *editorServices) renderSymbolReport(ctx fastnodectx.Context, sb symbolBundle) *editorapi.Report {
...
func ValidateID(ctx fastnodectx.Context, rm pythonresource.Manager, idx *pythonlocal.SymbolIndex, bi *bufferIndex, origID string) editorapi.ID {
	ctx.CheckAbort()
...
func renderID(ctx fastnodectx.Context, rm pythonresource.Manager, vb valueBundle) editorapi.ID {
	ctx.CheckAbort()
...
func renderSymbolID(ctx fastnodectx.Context, rm pythonresource.Manager, sb symbolBundle) editorapi.ID {
	ctx.CheckAbort()
...
func (s *editorServices) renderID(ctx fastnodectx.Context, vb valueBundle) editorapi.ID {
	return renderID(ctx, s.services.ResourceManager, vb)
}

func (s *editorServices) renderSymbolID(ctx fastnodectx.Context, sb symbolBundle) editorapi.ID {
...
func (s *editorServices) renderValueRepr(ctx fastnodectx.Context, vb valueBundle) string {
	ctx.CheckAbort()
...
func (s *editorServices) renderDetails(ctx fastnodectx.Context, vb valueBundle) editorapi.Details {
	ctx.CheckAbort()
...
func (s *editorServices) renderFunctionDetail(ctx fastnodectx.Context, vb valueBundle, typeSymbol pythonresource.Symbol) *editorapi.FunctionDetails {
	ctx.CheckAbort()
...
func (s *editorServices) renderTypeDetail(ctx fastnodectx.Context, vb valueBundle) *editorapi.TypeDetails {
	ctx.CheckAbort()
...
func (s *editorServices) renderModuleDetail(ctx fastnodectx.Context, vb valueBundle) *editorapi.ModuleDetails {
	msbs, total := s.memberSymbols(ctx, vb, 0, memberLimit)
...
func (s *editorServices) renderInstanceDetail(ctx fastnodectx.Context, vb valueBundle) *editorapi.InstanceDetails {
	return &editorapi.InstanceDetails{Type: s.renderUnion(ctx, vb.valueType(ctx))}
}

func (s *editorServices) baseResponse(ctx fastnodectx.Context, vb valueBundle) *editorapi.PythonBase {
	ctx.CheckAbort()
...
func (s *editorServices) renderDefinition(ctx fastnodectx.Context, vb valueBundle) *editorapi.Definition {
	ctx.CheckAbort()
...
func (s *editorServices) renderExamples(ctx fastnodectx.Context, vb valueBundle) []*editorapi.Example {
...
func (s *editorServices) renderSignatures(ctx fastnodectx.Context, vb valueBundle) []*editorapi.Signature {
	ctx.CheckAbort()
...
func (s *editorServices) scoreMember(ctx fastnodectx.Context, idx *pythonlocal.SymbolIndex, val pythontype.Value) int {
...
func (s *editorServices) memberSymbols(ctx fastnodectx.Context, vb valueBundle, offset, limit int) ([]symbolBundle, int) {
	ctx.CheckAbort()
...
// Ancestors
//
func (s *editorServices) renderValueAncestors(ctx fastnodectx.Context, vb valueBundle) []editorapi.Ancestor {
	ctx.CheckAbort()
...
func (s *editorServices) typeHintValueCompletion(ctx fastnodectx.Context, vb valueBundle) string {
	ctx.CheckAbort()
