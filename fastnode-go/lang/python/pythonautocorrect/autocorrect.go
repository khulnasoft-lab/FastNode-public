...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/autocorrect"
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonautocorrect/internal/options"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonautocorrect/internal/proposers"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonautocorrect/internal/selectors"
...
// Correct file.
func (c *Correcter) Correct(ctx fastnodectx.Context, uid int64, mid string, req editorapi.AutocorrectRequest) (autocorrect.Corrections, error) {
	ctx.CheckAbort()
