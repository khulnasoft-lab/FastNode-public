...
func (b *BuilderLoader) Build(ctx fastnodectx.Context, params localcode.BuilderParams) (*localcode.BuilderResult, error) {
	ctx.CheckAbort()
	...
	var result *Batch
	buildFunc := func(ctx fastnodectx.Context) error {
		ctx.CheckAbort()
