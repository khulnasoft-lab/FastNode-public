...
func GetInSameDir(ctx fastnodectx.Context, fpath string, files []*localfiles.File) ([]string, error) {
	ctx.CheckAbort()
...
func (s Selector) Select(ctx fastnodectx.Context) (map[string]*SourceUnit, map[string]bool, error) {
	ctx.CheckAbort()
...
func (s *Selector) addWork(ctx fastnodectx.Context, projectRemaining, libraryRemaining *int) {
...
func (s *Selector) addFile(ctx fastnodectx.Context, work fileToAdd) bool {
	ctx.CheckAbort()
	...
	ts := time.Now()
	err = fastnodectx.Background().WithTimeout(pythonparser.ParseTimeout, func(ctx fastnodectx.Context) (err error) {
...
func (s *Selector) handlePathImport(ctx fastnodectx.Context, pkgPath string, imp pythonstatic.ImportPath) *localfiles.File {
	ctx.CheckAbort()
...
func (s *Selector) handleHierarchicalImport(ctx fastnodectx.Context, dir string, imp pythonstatic.ImportPath) *localfiles.File {
	for {
...
func (s *Selector) handleRelativeImport(ctx fastnodectx.Context, imp pythonstatic.ImportPath, path, libraryPath string) *localfiles.File {
	ctx.CheckAbort()
...
func (s *Selector) handleImport(ctx fastnodectx.Context, imp pythonstatic.ImportPath, libraryPath string) (*localfiles.File, string) {
	ctx.CheckAbort()
...
func (s *Selector) preprocessFiles(ctx fastnodectx.Context) error {
...
func (s *Selector) inferProjectAndLibraryPaths(ctx fastnodectx.Context) {
	ctx.CheckAbort()
...
func findProjectDirs(ctx fastnodectx.Context, startPaths []string, fs localcode.FileSystem, logf func(msg string, vals ...interface{})) []string {
