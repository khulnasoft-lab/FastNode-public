...
func (a API) Complete(ctx fastnodectx.Context, opts CompleteOptions, req data.APIRequest, pyctx *python.Context, metricFn data.EngineMetricsCallback) data.APIResponse {
	return a.update(ctx, opts, req, pyctx, true, metricFn)
}

// Edit triggers the completions engine on the edit
func (a API) Edit(ctx fastnodectx.Context, opts CompleteOptions, req data.APIRequest, pyctx *python.Context) {
...
func (a API) update(ctx fastnodectx.Context, opts CompleteOptions, req data.APIRequest, pyctx *python.Context, requestCompletions bool, metricFn data.EngineMetricsCallback) data.APIResponse {
	defer func() {
		a.lastUsedLock.Lock()
		defer a.lastUsedLock.Unlock()
