...
func init() {
	...
	customProduct["fastnodebasic.py"] = licensing.Free
}
...
func runTestCases(t *testing.T, filename string, timeout time.Duration, opts api.CompleteOptions, productAccessor licensing.ProductGetter, testName string, matchedStates ...string) {
	...
	err := fastnodectx.Background().WithTimeout(500*time.Millisecond, func(ctx fastnodectx.Context) error {
		var err error
	...
	for _, stmt := range mod.Body {
		...
		t.Run(c.Name, func(t *testing.T) {
			...
			require.NoError(t, fastnodectx.Background().WithTimeout(timeout, func(ctx fastnodectx.Context) error {
...
func requireCompletions(ctx fastnodectx.Context, t *testing.T, tc corpustests.TestCase, options api.CompleteOptions, productAccessor licensing.ProductGetter) []data.RCompletion {
...
func runTestCase(ctx fastnodectx.Context, t *testing.T, c corpustests.TestCase, options api.CompleteOptions, productAccessor licensing.ProductGetter) {
