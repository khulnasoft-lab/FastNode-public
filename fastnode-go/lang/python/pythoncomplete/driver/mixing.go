...
func (s *scheduler) Mix(ctx fastnodectx.Context, opts MixOptions, pyctx *python.Context, g pythonproviders.Global, root data.SelectedBuffer) []data.NRCompletion {
	ctx.CheckAbort()
	if opts.NoSnippets {
...
func (m *Mixer) Mix(ctx fastnodectx.Context, pyctx *python.Context, g pythonproviders.Global, root data.SelectedBuffer) []data.NRCompletion {
