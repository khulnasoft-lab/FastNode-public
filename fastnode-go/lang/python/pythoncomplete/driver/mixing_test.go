...
func TestDedup(t *testing.T) {
	...
	result := testScheduler.Mix(fastnodectx.Context{}, MixOptions{}, nil, pythonproviders.Global{}, testBuffer)
	fmt.Println(result)
...
func TestBasic(t *testing.T) {
	...
	result := testScheduler.Mix(fastnodectx.Context{}, MixOptions{}, nil, pythonproviders.Global{}, sb)
	fmt.Println(result)
...
func TestMaxReturnedCompletions(t *testing.T) {
	...
	for _, maxReturnedCompletions := range []int{20, 10, 5} {
		...
		result := testScheduler.Mix(fastnodectx.Context{}, opts, nil, pythonproviders.Global{}, sb)
...
func TestCallPromotion(t *testing.T) {
	...
	// set the flag to true and set MaxreturnedCompletions the same as in fastnoded.
	result := testScheduler.Mix(fastnodectx.Context{}, MixOptions{GGNNSubtokenEnabled: true, MaxReturnedCompletions: 0}, nil, pythonproviders.Global{}, sb)
