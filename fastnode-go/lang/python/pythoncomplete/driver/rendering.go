...
func getIDs(ctx fastnodectx.Context, g pythonproviders.Global, val pythontype.Value) (web string, local string) {
	if val == nil {
		return "", ""
	}
...
func getDoc(ctx fastnodectx.Context, pyctx *python.Context, g pythonproviders.Global, val pythontype.Value) (doc string, isHTML bool) {
...
func (m *Mixer) makeCompletion(ctx fastnodectx.Context, pyctx *python.Context, g pythonproviders.Global, c Completion) data.RCompletion {
	ctx.CheckAbort()
...
func (m *Mixer) renderCompletions(ctx fastnodectx.Context, pyctx *python.Context, g pythonproviders.Global, completions *CompletionTree) []data.NRCompletion {
