...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythoncomplete/offline/scoring"
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythoncomplete/offline/completion"
...
func main() {
	...
	computeAndWriteScores("/data/fastnode/mixing/scores.json", collection, completionProvider)
