...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythontracking/highlight"
...
func (a *app) renderAST(idx int, buf string, ex example.Example) (string, error) {
	...
	ast, _ := pythonparser.Parse(fastnodectx.Background(), []byte(buf), pythonparser.Options{
		Approximate: true,
		Cursor:      &cursor,
