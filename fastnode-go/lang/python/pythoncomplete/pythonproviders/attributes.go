...
func (a Attributes) Provide(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) error {
...
func provideAttributesFor(ctx fastnodectx.Context, g Global, val pythontype.Value, isValid func(string) bool, emit func(string, pythontype.Value, float64)) {
...
type freqScorer = func(fastnodectx.Context, pythontype.Value) int

func localFreqScorer(local *pythonlocal.SymbolIndex) freqScorer {
	if local == nil {
		return func(fastnodectx.Context, pythontype.Value) int { return 0 }
	}
	return func(ctx fastnodectx.Context, val pythontype.Value) int {
		if val == nil {
			return 0
		}
