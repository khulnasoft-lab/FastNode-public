...
func (dp DictKeys) Provide(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) error {
	ctx.CheckAbort()
...
func (dp DictKeys) provideBracketCompletion(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) (bool, error) {
	ctx.CheckAbort()
...
func (dp DictKeys) provideGetPopCompletions(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) (bool, error) {
...
func (dp DictKeys) provideAttributeCompletion(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) (bool, error) {
	ctx.CheckAbort()
...
func (dp DictKeys) emit(ctx fastnodectx.Context, out OutputFunc, sb data.SelectedBuffer, kc keyCompletion, attrToSubs bool, compl data.Completion) {
