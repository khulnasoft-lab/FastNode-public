...
func requireTestCaseWithDictKey(t *testing.T, src string) testCase {
	...
	inputs, err := NewInputs(fastnodectx.Background(), global, sb, true, false)
...
secondDict.t$`)
	comps := requireCompletions(t, tc, DictKeys{})
	// This test is NOT representative of the reality, if you try this block of code in fastnoded, you'll get 2 keys
...
secondDict.t$`)
	...
	// It's the case in fastnoded, not in this test
