...
func (EmptyCalls) Provide(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) error {
	ctx.CheckAbort()
...
func getEmptyCallSnippet(ctx fastnodectx.Context, g Global, val pythontype.Value) data.Snippet {
