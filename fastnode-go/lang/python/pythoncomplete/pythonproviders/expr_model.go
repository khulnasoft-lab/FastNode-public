...
func (e ExprModel) Provide(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) error {
	ctx.CheckAbort()
...
func providePlaceholderCompletion(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc, expr pythonast.Expr, sym mtacconf.CallSym) error {
...
func clearPlaceholders(ctx fastnodectx.Context, g Global, in Inputs, expr pythonast.Expr, sym mtacconf.CallSym) (*pythonanalyzer.ResolvedAST, *pythonast.NameExpr, string, error) {
...
func isPlaceholder(ctx fastnodectx.Context, g Global, in Inputs, expr pythonast.Expr) (bool, mtacconf.CallSym) {
...
func computeMTACConfSkip(ctx fastnodectx.Context, g Global, in Inputs, c MetaCompletion, mixData mtacconf.MixData) bool {
	ctx.CheckAbort()
