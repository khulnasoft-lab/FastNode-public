...
// Provide ...
func (p GGNNModel) Provide(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) error {
	ctx.CheckAbort()
...
func (p GGNNModel) processPartialResults(ctx fastnodectx.Context, g Global, in Inputs, predictions []pythongraph.Prediction, out OutputFunc, buffer data.SelectedBuffer, replace data.Selection, expr pythonast.Expr) error {
...
func computeCallProbs(ctx fastnodectx.Context, g Global, callProbIn callprob.Inputs, predictions []pythongraph.Prediction) {
