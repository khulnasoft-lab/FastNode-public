...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythoncomplete/pythonproviders/legacy"
...
func (Imports) Provide(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) error {
	ctx.CheckAbort()
