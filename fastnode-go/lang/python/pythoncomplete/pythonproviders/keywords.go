...
func (Keywords) Provide(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) error {
	ctx.CheckAbort()
...
func runModel(ctx fastnodectx.Context, g Global, in Inputs) (float32, map[pythonscanner.Token]float32) {
