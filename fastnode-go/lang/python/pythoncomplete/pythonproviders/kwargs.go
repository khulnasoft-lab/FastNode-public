...
func (a KWArgs) Provide(ctx fastnodectx.Context, g Global, in Inputs, out OutputFunc) error {
	ctx.CheckAbort()
	...
	if in.Selection.Len() > 0 {
		// Fix for issue 8162 : https://github.com/khulnasoft-lab/fastnode/issues/8162
