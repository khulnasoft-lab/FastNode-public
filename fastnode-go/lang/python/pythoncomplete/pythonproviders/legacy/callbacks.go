...
type Callbacks interface {
	...
	PkgMembers(ctx fastnodectx.Context, pkg *pythonast.DottedExpr, numDots int) (map[string]pythontype.Value, string)

	// ScoreImportEdge should return a score for an import completion
	ScoreImportEdge(ctx fastnodectx.Context, val pythontype.Value) float64
	...
	Subpackages(ctx fastnodectx.Context, pkg *pythonast.DottedExpr, fromDots int, name *pythonast.NameExpr) (map[string]pythontype.Value, string)
	...
	// alias represents.
	ImportAliases(ctx fastnodectx.Context, module, alias *pythonast.NameExpr) (Edge, map[string]float64)
	// ImportAliasesForValue skips the resolved AST lookup
	ImportAliasesForValue(ctx fastnodectx.Context, val pythontype.Value) map[string]float64
}
...
func (c CompletionsCallbacks) PkgMembers(ctx fastnodectx.Context, pkg *pythonast.DottedExpr, numDots int) (map[string]pythontype.Value, string) {
	ctx.CheckAbort()
...
func (c CompletionsCallbacks) ScoreImportEdge(ctx fastnodectx.Context, val pythontype.Value) float64 {
...
func (c CompletionsCallbacks) Subpackages(ctx fastnodectx.Context, pkg *pythonast.DottedExpr, fromDots int, name *pythonast.NameExpr) (map[string]pythontype.Value, string) {
	ctx.CheckAbort()
...
func (c CompletionsCallbacks) ImportAliases(ctx fastnodectx.Context, module, alias *pythonast.NameExpr) (Edge, map[string]float64) {
	ctx.CheckAbort()
...
func (c CompletionsCallbacks) ImportAliasesForValue(ctx fastnodectx.Context, val pythontype.Value) map[string]float64 {
	sym := getSingleGlobalSymbolFromValue(ctx, val)
	if sym.Nil() {
		return nil
	}
...
func (c CompletionsCallbacks) localImportEdges(ctx fastnodectx.Context, out map[string]pythontype.Value) map[string]pythontype.Value {
	ctx.CheckAbort()
...
func getSingleGlobalSymbolFromValue(ctx fastnodectx.Context, val pythontype.Value) pythonresource.Symbol {
...
func scoreValueCompletion(ctx fastnodectx.Context, child pythontype.Value, rm pythonresource.Manager, idx *pythonlocal.SymbolIndex, scorer symbolcounts.Scorer) int {
	ctx.CheckAbort()
...
func scoreExternal(ctx fastnodectx.Context, val pythontype.Value, rm pythonresource.Manager, scorer symbolcounts.Scorer) int {
	ctx.CheckAbort()
