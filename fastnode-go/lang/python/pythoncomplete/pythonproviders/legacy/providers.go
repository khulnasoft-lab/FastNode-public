...
func importPackages(ctx fastnodectx.Context, pkg *pythonast.DottedExpr, numDots int, cb Callbacks) ProvisionResult {
	ctx.CheckAbort()
...
func importSubpackages(ctx fastnodectx.Context, i ImportSubpackage, cb Callbacks) ProvisionResult {
	ctx.CheckAbort()
...
func addAliasesToPackages(ctx fastnodectx.Context, prefix pythonimports.DottedPath, pkgRes ProvisionResult, cb Callbacks) {
	ctx.CheckAbort()
...
func importAliases(ctx fastnodectx.Context, in Inputs, i ImportAlias, cb Callbacks) ProvisionResult {
	ctx.CheckAbort()
	if cb.GetProduct() != licensing.Pro {
