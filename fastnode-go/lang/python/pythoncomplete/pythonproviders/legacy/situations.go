...
type Situation interface {
	...
	Provide(ctx fastnodectx.Context, in Inputs, cb Callbacks, prefetch bool) ProvisionResult
}
...
func (i ImportPackage) Provide(ctx fastnodectx.Context, in Inputs, cb Callbacks, prefetch bool) ProvisionResult {
	ctx.CheckAbort()
...
// Provide implements Situation
func (i FromImport) Provide(ctx fastnodectx.Context, in Inputs, cb Callbacks, prefetch bool) ProvisionResult {
...
// Provide implements Situation
func (i ImportSubpackage) Provide(ctx fastnodectx.Context, in Inputs, cb Callbacks, prefetch bool) ProvisionResult {
...
// Provide implements Situation
func (i ImportAlias) Provide(ctx fastnodectx.Context, in Inputs, cb Callbacks, prefetch bool) ProvisionResult {
