...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/curation/segment"
...
func TestBuildDirStructure_AbsPath(t *testing.T) {
	names := map[string]string{
		"/fastnodetest/dirA":           "application/x-directory",
		"/fastnodetest/dirA/blahA.txt": "text/plain",
		"/fastnodetest/dirA/blahB.txt": "text/plain",
		"/fastnodetest/hello.txt":      "text/plain",
	}
	root := buildDirStructure("/fastnodetest", names)

	assert.Equal(t, "/fastnodetest", root.Name, "expected root name to be /fastnodetest")
