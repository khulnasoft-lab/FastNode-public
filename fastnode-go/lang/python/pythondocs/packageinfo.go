...
const (
	...
	DefaultRTDDatafilePath = "/var/fastnode/data/docs/python/rtdinfo.json.gz"
	// DefaultDocsDatafilePath is the default location for the docs info file.
	DefaultDocsDatafilePath = "/var/fastnode/data/docs/python/docsinfo.json.gz"
	// DefaultDocsSourcePath is the default location for the documentation source files.
	DefaultDocsSourcePath = "/var/fastnode/data/docs/python/source/"
	// DefaultDocsParsedPath is the default location for the parsed documentation tuple files.
	DefaultDocsParsedPath = "/var/fastnode/data/docs/python/parsed/"
)
