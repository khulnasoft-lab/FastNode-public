...
// ImportAbs finds the node for the given top-level package (e.g. "fastnode" in "import fastnode.foo.bar")
...
func (t *SourceTree) Flatten(ctx fastnodectx.Context) (*FlatSourceTree, error) {
	ctx.CheckAbort()
...
func (t *SourceTree) Locate(ctx fastnodectx.Context, loc string) (pythontype.Value, error) {
	ctx.CheckAbort()
...
// could be found.
func (t *SourceTree) LocateSymbol(ctx fastnodectx.Context, loc string) (pythontype.Value, pythontype.Value, string, error) {
	ctx.CheckAbort()
...
func (t *SourceTree) FindSymbol(ctx fastnodectx.Context, file string, path []string, attr string) (pythontype.Value, pythontype.Value, error) {
...
func (t *SourceTree) FindValue(ctx fastnodectx.Context, file string, path []string) (pythontype.Value, error) {
	ctx.CheckAbort()
...
func findAttr(ctx fastnodectx.Context, val pythontype.Value, name string, steps int) pythontype.Value {
