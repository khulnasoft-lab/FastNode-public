...
var (
	...
	// fastnode_status metric to count how many shards are loaded
	loadedExprShards = fastnodestatus.GetCounter("expr_shards_loaded")
)
...
func (m *ShardedModel) Predict(ctx fastnodectx.Context, in Input) (*GGNNResults, error) {
