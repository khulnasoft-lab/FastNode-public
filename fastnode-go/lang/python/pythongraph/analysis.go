...
func analyze(ctx fastnodectx.Context, rm pythonresource.Manager, src []byte) (*analysis, error) {
...
func (a *analysis) Resolve(ctx fastnodectx.Context, expr pythonast.Expr) pythontype.Value {
	ctx.CheckAbort()

	return a.RAST.References[expr]
}

func (a *analysis) SetResolved(ctx fastnodectx.Context, expr pythonast.Expr, val pythontype.Value) func() {
	ctx.CheckAbort()
...
func (a *analysis) ResolveToGlobals(ctx fastnodectx.Context, expr pythonast.Expr) []pythontype.GlobalValue {
...
func (a *analysis) ResolveToSymbols(ctx fastnodectx.Context, expr pythonast.Expr) []pythonresource.Symbol {
	ctx.CheckAbort()
...
func (a *analysis) ResolveToPaths(ctx fastnodectx.Context, expr pythonast.Expr, canonicalize bool) []pythonimports.DottedPath {
	ctx.CheckAbort()
...
func (a *analysis) translate(ctx fastnodectx.Context, val pythontype.Value) []pythontype.GlobalValue {
	ctx.CheckAbort()
	if val == nil {
		return nil
	}
