...
func NewArgTypeTrainSample(config TrainConfig, params TrainParams, in ArgTypeTrainInputs) (*InferProductionSample, error) {
	...
	site1 := builder1.randomArgTypeSite(fastnodectx.Background(), params.Rand, sym)
...
func (b *graphBuilder) randomArgTypeSite(ctx fastnodectx.Context, rand *rand.Rand, sym pythonresource.Symbol) argTypeSite {
	ctx.CheckAbort()
