...
func newBuilder(ctx fastnodectx.Context, a *analysis, addMissingNames, instanceTypes bool) *graphBuilder {
	ctx.CheckAbort()
...
func (b *graphBuilder) attributesFor(ctx fastnodectx.Context, node pythonast.Node, instanceTypes bool) Attributes {
	attrs := Attributes{
