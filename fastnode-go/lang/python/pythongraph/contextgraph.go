...
// NewContextGraph ...
func NewContextGraph(ctx fastnodectx.Context, config ContextGraphConfig, in ContextGraphInputs) (*ContextGraph, error) {
...
func newContextGraph(ctx fastnodectx.Context, config ContextGraphConfig, in ContextGraphInputs, a *analysis) (*ContextGraph, error) {
