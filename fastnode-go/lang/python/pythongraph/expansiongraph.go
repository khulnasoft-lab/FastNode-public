...
type EgCallbacks interface {
	...
	TaskCompleted(ctx fastnodectx.Context, eg ExpansionGraphMutate, t EgTask, remaining EgTaskStack) (EgTaskStack, error)
	...
	InferNameDecoderEmbeddings(ctx fastnodectx.Context, eg ExpansionGraphNavigate, site *Node) ([]string, []string, error)
}
...
func (e EgUpdate) Expand(ctx fastnodectx.Context) (EgUpdates, error) {
	if e.stack.Empty() {
		return nil, nil
	}
...
func (e EgUpdate) taskCompleted(ctx fastnodectx.Context, t EgTask, remaining EgTaskStack) (EgUpdates, error) {
...
func (e EgUpdate) propagate(ctx fastnodectx.Context, t EgTask, remaining EgTaskStack) (EgUpdates, error) {
...
func (e EgUpdate) inferProduction(ctx fastnodectx.Context, t EgTask, remaining EgTaskStack) (EgUpdates, error) {
...
func (e EgUpdate) inferName(ctx fastnodectx.Context, t EgTask, remaining EgTaskStack) (EgUpdates, error) {
	// deep copy of the base so that we can modify it for prediction,
	// also need to do a deep copy to make things idempotent
...
func (e *ExpansionGraph) propagateTF(ctx fastnodectx.Context, task EgTask) error {
...
func (e *ExpansionGraph) inferNameTF(ctx fastnodectx.Context, task EgTask, usages []*Node, types, subtokens []string) ([]inferredNameData, error) {
...
func (e *ExpansionGraph) inferProdTF(ctx fastnodectx.Context, task EgTask) ([]float32, error) {
