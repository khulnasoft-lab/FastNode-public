...
// Here we replicate the logic from https://github.com/khulnasoft-lab/fastnode/blob/master/fastnode-python/fastnode_ml/fastnode/graph_encoder/encoder.py#L172
