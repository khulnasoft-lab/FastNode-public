...
func (b *graphBuilder) Prune(ctx fastnodectx.Context, keep nodeSet, hops int) {
	ctx.CheckAbort()
...
func (b *graphBuilder) RestrictTo(ctx fastnodectx.Context, keep nodeSet) {
...
// `to` is NOT modified
func (b *graphBuilder) Connected(ctx fastnodectx.Context, to nodeSet, hops int) nodeSet {
	ctx.CheckAbort()
...
func visit(ctx fastnodectx.Context, n *Node, connected nodeSet, hops int) {
	ctx.CheckAbort()
