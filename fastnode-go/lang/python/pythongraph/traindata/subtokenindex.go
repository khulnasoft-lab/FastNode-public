...
const (
	...
	SubtokenIndexPath = "s3://fastnode-data/python-index-subtokens/2019-01-29_06-49-45-AM.index.json"
	// NewSubtokenIndexPath is the path to the name subtoken index from the new github dump
	NewSubtokenIndexPath = "s3://fastnode-data/python-index-subtokens/2019-08-20_04-19-07-PM.index.json"
)
