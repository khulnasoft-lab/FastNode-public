...
func NodesUnderCursor(ctx fastnodectx.Context, ast pythonast.Node, cur int64) []pythonast.Node {
	ctx.CheckAbort()
...
func DeepestContainingSelection(ctx fastnodectx.Context, ast pythonast.Node, start, end int64) pythonast.Node {
	ctx.CheckAbort()
...
func InspectContainingSelection(ctx fastnodectx.Context, ast pythonast.Node, start, end int64, cb func(pythonast.Node) bool) {
	ctx.CheckAbort()
