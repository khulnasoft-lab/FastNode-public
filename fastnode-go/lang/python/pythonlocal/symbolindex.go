...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonindex"
...
func (s *SymbolIndex) LocateSymbol(ctx fastnodectx.Context, id string) (pythontype.Value, pythontype.Value, string, error) {
	ctx.CheckAbort()
	if s.SourceTree != nil {
...
func (s *SymbolIndex) FindSymbol(ctx fastnodectx.Context, file string, path []string, attr string) (pythontype.Value, pythontype.Value, error) {
	ctx.CheckAbort()
	if s.SourceTree != nil {
...
func (s *SymbolIndex) Locate(ctx fastnodectx.Context, id string) (pythontype.Value, error) {
	ctx.CheckAbort()
	if s.SourceTree != nil {
...
func (s *SymbolIndex) FindValue(ctx fastnodectx.Context, file string, path []string) (pythontype.Value, error) {
	ctx.CheckAbort()
	if s.SourceTree != nil {
...
func (s *SymbolIndex) Package(ctx fastnodectx.Context, p string) (*pythontype.SourcePackage, error) {
	ctx.CheckAbort()
	if s.SourceTree != nil {
...
func (s *SymbolIndex) Cleanup() error {
	// Nothing to cleanup if ArtifactRoot is empty (for fastnode local)
	if s.ArtifactRoot == "" {
		return nil
	}
...
func (s *SymbolIndex) Documentation(ctx fastnodectx.Context, v pythontype.Value) (*Documentation, error) {
	ctx.CheckAbort()
...
func (s *SymbolIndex) Definition(ctx fastnodectx.Context, v pythontype.Value) (*Definition, error) {
	ctx.CheckAbort()
...
func (s *SymbolIndex) ArgSpec(ctx fastnodectx.Context, v pythontype.Value) (*pythonimports.ArgSpec, error) {
	ctx.CheckAbort()
	if s.ArgSpecMap == nil {
		return nil, ErrUnknownNode
	}
...
func (s *SymbolIndex) ValueCount(ctx fastnodectx.Context, v pythontype.Value) (int, error) {
	ctx.CheckAbort()
...
func (s *SymbolIndex) MethodPatterns(ctx fastnodectx.Context, v pythontype.Value) (*pythoncode.MethodPatterns, error) {
	ctx.CheckAbort()
	start := time.Now()
	defer func() {
