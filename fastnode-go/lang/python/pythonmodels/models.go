...
// this struct is serialized to JSON as part of fastnode_status metrics
type Options struct {
	Local                     bool `json:"-"`
...
var DefaultOptions = Options{
	...
	KeywordModelPath:          "s3://fastnode-data/keyword-model/2019-06-19/keyword_model.frozen.pb",
	MTACConfModelPath:         "s3://fastnode-data/python-mtac-confidence/2019-05-03_08-02-59-PM/serve",
	CallProbSubtokenModelPath: "s3://fastnode-data/python-call-prob/2020-02-13_06-26-58-PM/serve",
	CallProbCallModelPath:     "s3://fastnode-data/python-call-prob/2019-11-12_06-22-20-PM/serve",

	// not currently used, but preserving this path for the near future (as of 2019-06-03)
	// MixModelPath: "s3://fastnode-data/python-completion-mixing/2019-01-25_09-06-42-PM/serve/mix_model.frozen.pb",
}
