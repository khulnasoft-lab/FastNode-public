...
// file identified by the environment variable FASTNODE_EPYTEXT_DATASET.
...
// of that key.
//
// The environment variables FASTNODE_EPYTEXT_DATASET_OFFSET and
// FASTNODE_EPYTEXT_DATASET_LIMIT can specify an offset and limit number
// of cases to run in the dataset. If the FASTNODE_EPYTEXT_DATASET_KEY
...
func WithDataSet(t *testing.T, fn func(*testing.T, int, string, string)) {
	filename := os.Getenv("FASTNODE_EPYTEXT_DATASET")
	if filename == "" {
		t.Skip("no dataset file specified; set environment variable FASTNODE_EPYTEXT_DATASET to run\n\toptions: FASTNODE_EPYTEXT_DATASET_OFFSET=n FASTNODE_EPYTEXT_DATASET_LIMIT=n FASTNODE_EPYTEXT_DATASET_KEY=key")
	}
	offset, _ := strconv.Atoi(os.Getenv("FASTNODE_EPYTEXT_DATASET_OFFSET"))
	limit, _ := strconv.Atoi(os.Getenv("FASTNODE_EPYTEXT_DATASET_LIMIT"))
	uniqueKey := os.Getenv("FASTNODE_EPYTEXT_DATASET_KEY")
