...
import (
	...
	rmcounts "github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonresource/internal/resources/symbolcounts"
...
func init() {
	...
	cmd.Flags().StringVar(&cacheDir, "cachedir", "/tmp/fastnode-local-pipelines", "cache directory")
}
