...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonresource/internal/resources"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonresource/internal/stringutil"
...
var DefaultOptions = Options{
	Manifest:  manifest.FastnodeManifest,
	Dists:     nil,
	DistIndex: distidx.FastnodeIndex,

	DistLoadAttempts: 3,
	DistLoadBackoff:  5 * time.Second,
}

// DefaultLocalOptions is the default argument to NewManager for Fastnode Local.
var DefaultLocalOptions = Options{
	Manifest:     manifest.FastnodeManifest,
	Dists:        []keytypes.Distribution{},
	DistIndex:    distidx.FastnodeIndex,
	ToplevelPath: "s3://fastnode-resource-manager/python-v2/toplevel20200720.gob.gz",
