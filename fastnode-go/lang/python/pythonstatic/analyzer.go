...
func (a *Analyzer) Module(ctx fastnodectx.Context, module *pythontype.SourceModule, node *pythonast.Module, imp Importer) {
	ctx.CheckAbort()
...
func (a *Analyzer) Function(ctx fastnodectx.Context, fun *pythontype.SourceFunction, node *pythonast.FunctionDefStmt, imp Importer) {
	ctx.CheckAbort()
...
func (a *Analyzer) Lambda(ctx fastnodectx.Context, lambda *pythontype.SourceFunction, node *pythonast.LambdaExpr, imp Importer) {
	ctx.CheckAbort()
