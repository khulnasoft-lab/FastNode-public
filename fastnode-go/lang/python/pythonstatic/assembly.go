...
func BuiltinScope(ctx fastnodectx.Context, graph pythonresource.Manager) *pythontype.SymbolTable {
	ctx.CheckAbort()
...
func NewAssembler(ctx fastnodectx.Context, ai AssemblerInputs, opts Options) *Assembler {
...
func (b *Assembler) Build(ctx fastnodectx.Context) (assembly *Assembly, err error) {
	ctx.CheckAbort()
