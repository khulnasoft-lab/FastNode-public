...
func (d djangoModelMetaClass) Construct(ctx fastnodectx.Context, c *pythontype.SourceClass, symbols *pythontype.SymbolTable) {
	ctx.CheckAbort()
...
func updateSymbolWithDjangoRequest(ctx fastnodectx.Context, s *pythontype.Symbol, importer Importer) {
	ctx.CheckAbort()
...
func updateSymbolWithDjangoQuerySet(ctx fastnodectx.Context, s *pythontype.Symbol, f *pythontype.SourceFunction) {
	ctx.CheckAbort()
...
func doDjangoGetModelHeuristic(ctx fastnodectx.Context, args pythontype.Args, prop *propagator) []pythontype.Value {
	ctx.CheckAbort()
