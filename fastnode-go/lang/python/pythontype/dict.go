...
func (v DictInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "clear":
...
func (v DictInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v DictInstance) hash(ctx fastnodectx.CallContext) FlatID {
