...
// TODO(juan): add rest of members
func (v ManagerInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "aggregate":
...
func (v ManagerInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v ManagerInstance) hash(ctx fastnodectx.CallContext) FlatID {
...
// attr looks up an attribute on this value
func (v QuerySetInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "aggregate":
		// NOTE(Juan): account for other aggregate methods
...
func (v QuerySetInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (used during serialization)
func (v QuerySetInstance) hash(ctx fastnodectx.CallContext) FlatID {
...
func (v OptionsInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	...
	case "get_field":
		fn := func(args Args) Value {
			...
			if fieldname != "" && v.Model != nil {
				res, err := Attr(fastnodectx.TODO(), v.Model, fieldname)
...
func (v OptionsInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v OptionsInstance) hash(ctx fastnodectx.CallContext) FlatID {
...
func pyGetObjectOr404(args Args) Value {
	...
	var out []Value
	for _, v := range Disjuncts(fastnodectx.TODO(), args.Positional[0]) {
		if ctor, ok := v.(Callable); ok && v.Kind() == TypeKind {
			out = append(out, ctor.Call(Args{}))
		}
	}
	return Unite(fastnodectx.TODO(), out...)
}
...
func pyGetListOr404(args Args) Value {
	...
	return NewList(Unite(fastnodectx.TODO(), out...))
}
