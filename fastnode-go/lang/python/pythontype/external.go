...
func (v ExternalRoot) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
...
func (v ExternalRoot) equal(ctx fastnodectx.CallContext, val Value) bool {
...
func (v ExternalRoot) hash(ctx fastnodectx.CallContext) FlatID {
	return saltExternal
}
...
func (v External) Call(args Args) Value {
	...
	return Unite(fastnodectx.TODO(), typeVals...)
}
...
func (v External) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
...
func (v External) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v External) hash(ctx fastnodectx.CallContext) FlatID {
	dist := v.symbol.Dist()
...
func (v ExternalInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return attr(ctx, v.TypeExternal, name)
}

// equal determines whether this value is equal to another value
func (v ExternalInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (used during serialization)
func (v ExternalInstance) hash(ctx fastnodectx.CallContext) FlatID {
...
// attr gets the named attribute. Steps is a counter to avoid infinite loops.
func (v ExternalReturnValue) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return AttrResult{}, ErrNotFound
}

// equal determines whether this value is equal to another value
func (v ExternalReturnValue) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (used during serialization)
func (v ExternalReturnValue) hash(ctx fastnodectx.CallContext) FlatID {
	dist := v.fn.Dist()
