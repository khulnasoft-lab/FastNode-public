...
func (g GeneratorInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "close":
...
func (g GeneratorInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (g GeneratorInstance) hash(ctx fastnodectx.CallContext) FlatID {
