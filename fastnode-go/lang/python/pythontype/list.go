...
func (v ListInstance) SetIndex(index Value, value Value, allowValueMutation bool) Value {
	return NewList(Unite(fastnodectx.TODO(), v.Element, value))
}

// attr looks up an attribute on this value
func (v ListInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "append":
...
func (v ListInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v ListInstance) hash(ctx fastnodectx.CallContext) FlatID {
