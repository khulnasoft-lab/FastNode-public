...
func (d DataFrame) hash(ctx fastnodectx.CallContext) FlatID {
	return rehash(saltType, FlatID(dataFrameAddress.Path.Hash))
}

func (d DataFrame) equal(ctx fastnodectx.CallContext, v Value) bool {
...
func (d DataFrame) attr(ctx fastnodectx.CallContext, s string) (AttrResult, error) {
...
func (df DataFrameInstance) hash(ctx fastnodectx.CallContext) FlatID {
	return df.delegate.hash(ctx)
}

func (df DataFrameInstance) equal(ctx fastnodectx.CallContext, val Value) bool {
...
func (df DataFrameInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
