...
func (p PropertyUpdater) equal(ctx fastnodectx.CallContext, other Value) bool {
...
func (p PropertyUpdater) hash(ctx fastnodectx.CallContext) FlatID {
	return rehashBytes(rehashValues(ctx, saltPropertyUpdater, p.Instance), []byte(p.Which))
}

// attr implements Value
func (p PropertyUpdater) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
...
// equal implements Value
func (p PropertyInstance) equal(ctx fastnodectx.CallContext, other Value) bool {
...
// Hash implements Value
func (p PropertyInstance) hash(ctx fastnodectx.CallContext) FlatID {
	return rehashValues(ctx, saltProperty, p.FGet, p.FSet)
}

// attr implements Value
func (p PropertyInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "getter":
