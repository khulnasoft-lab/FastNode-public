...
func Reprs(ctx fastnodectx.Context, val Value, rm pythonresource.Manager, last bool) []string {
	ctx.CheckAbort()
...
func reprsImpl(ctx fastnodectx.CallContext, val Value, last bool) []string {
	ctx.CheckAbort()
