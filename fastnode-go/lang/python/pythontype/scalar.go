...
func (v NoneConstant) hash(ctx fastnodectx.CallContext) FlatID { return saltNone }
...
func (v NoneConstant) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v NoneConstant) equal(ctx fastnodectx.CallContext, u Value) bool {
	_, eq := u.(NoneConstant)
	return eq
}
...
// hash gets a unique ID for this value (for serialization)
func (v BoolConstant) hash(ctx fastnodectx.CallContext) FlatID {
	if v {
		return saltTrue
	}
	return saltFalse
...
// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v BoolConstant) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v BoolConstant) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (for serialization)
func (v BoolInstance) hash(ctx fastnodectx.CallContext) FlatID { return saltBool }

// Flatten creates a non-recursive version of this type for serialization
func (v BoolInstance) Flatten(f *FlatValue, r *Flattener) { f.Scalar = addr(FlatBool) }

// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v BoolInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v BoolInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
	_, eq := u.(BoolInstance)
	return eq
}
...
// hash gets a unique ID for this value (for serialization)
func (v IntConstant) hash(ctx fastnodectx.CallContext) FlatID { return rehash(saltInt, FlatID(v)) }
...
// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v IntConstant) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v IntConstant) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (for serialization)
func (v IntInstance) hash(ctx fastnodectx.CallContext) FlatID { return saltInt }

// Flatten creates a non-recursive version of this type for serialization
func (v IntInstance) Flatten(f *FlatValue, r *Flattener) { f.Scalar = addr(FlatInt) }

// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v IntInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v IntInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
	_, eq := u.(IntInstance)
	return eq
}
...
// hash gets a unique ID for this value (for serialization)
func (v FloatConstant) hash(ctx fastnodectx.CallContext) FlatID {
...
// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v FloatConstant) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v FloatConstant) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (for serialization)
func (v FloatInstance) hash(ctx fastnodectx.CallContext) FlatID { return saltFloat }

// Flatten creates a non-recursive version of this type for serialization
func (v FloatInstance) Flatten(f *FlatValue, r *Flattener) { f.Scalar = addr(FlatFloat) }

// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v FloatInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v FloatInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (for serialization)
func (v ComplexConstant) hash(ctx fastnodectx.CallContext) FlatID {
...
// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v ComplexConstant) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v ComplexConstant) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (for serialization)
func (v ComplexInstance) hash(ctx fastnodectx.CallContext) FlatID { return saltComplex }

// Flatten creates a non-recursive version of this type for serialization
func (v ComplexInstance) Flatten(f *FlatValue, r *Flattener) { f.Scalar = addr(FlatComplex) }

// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v ComplexInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v ComplexInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (for serialization)
func (v StrConstant) hash(ctx fastnodectx.CallContext) FlatID { return rehashBytes(saltStr, []byte(v)) }
...
// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v StrConstant) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v StrConstant) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a unique ID for this value (for serialization)
func (v StrInstance) hash(ctx fastnodectx.CallContext) FlatID { return saltStr }

// Flatten creates a non-recursive version of this type for serialization
func (v StrInstance) Flatten(f *FlatValue, r *Flattener) { f.Scalar = addr(FlatStr) }

// attr gets the value of an attribute. Steps is a counter to avoid infinite loops.
func (v StrInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v StrInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
	_, eq := u.(StrInstance)
	return eq
}
