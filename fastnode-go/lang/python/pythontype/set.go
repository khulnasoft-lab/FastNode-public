...
func (v SetInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "add":
...
func (v SetInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v SetInstance) hash(ctx fastnodectx.CallContext) FlatID {
