...
func (v *SourceFunction) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
...
func (v *SourceFunction) equal(ctx fastnodectx.CallContext, other Value) bool {
...
func (v *SourceFunction) hash(ctx fastnodectx.CallContext) FlatID {
...
// attr gets the type of the named attribute
func (v *SourceClass) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "__dict__":
...
func (v *SourceClass) AttrSymbol(ctx fastnodectx.Context, name string, create bool) (syms []*Symbol) {
	ctx.WithCallLimit(maxSteps, func(ctx fastnodectx.CallContext) error {
...
func internalAttr(ctx fastnodectx.CallContext, v *SourceClass, name string, syms *[]*Symbol) error {
	ctx.CheckAbort()
...
// unionBaseLookup internally increments ctx call count
func unionBaseLookup(ctx fastnodectx.CallContext, u Union, name string, syms *[]*Symbol) error {
	ctx.CheckAbort()
...
// equal determines whether this value is equal to another value
func (v *SourceClass) equal(ctx fastnodectx.CallContext, other Value) bool {
...
// hash gets a unique ID for this value
func (v *SourceClass) hash(ctx fastnodectx.CallContext) FlatID {
...
// attr gets the type of the named attribute
func (v SourceInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "__class__":
...
func (v SourceInstance) AttrSymbol(ctx fastnodectx.Context, attr string, create bool) []*Symbol {
	return v.Class.AttrSymbol(ctx, attr, create)
}

// equal determines whether this value is equal to another value
func (v SourceInstance) equal(ctx fastnodectx.CallContext, other Value) bool {
...
// hash gets a unique ID for this value
func (v SourceInstance) hash(ctx fastnodectx.CallContext) FlatID {
...
// attr gets the type of the named attribute
func (v *SourceModule) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "__dict__":
		return SingleResult(NewDict(StrInstance{}, nil), v), nil
...
// AttrSymbol gets the symbol for a named attribute
func (v *SourceModule) AttrSymbol(ctx fastnodectx.Context, attr string, create bool) []*Symbol {
...
// equal determines whether this value is equal to another value
func (v *SourceModule) equal(ctx fastnodectx.CallContext, other Value) bool {
...
// hash gets a unique ID for this value
func (v *SourceModule) hash(ctx fastnodectx.CallContext) FlatID {
...
func (v *SourcePackage) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
...
// equal determines whether this value is equal to another value
func (v *SourcePackage) equal(ctx fastnodectx.CallContext, other Value) bool {
...
// hash gets a unique ID for this value
func (v *SourcePackage) hash(ctx fastnodectx.CallContext) FlatID {
