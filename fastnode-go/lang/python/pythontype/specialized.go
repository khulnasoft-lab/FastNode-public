...
func (v ExplicitModule) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, v.Members, nil)
}

// equal determines whether this value is equal to another value
func (v ExplicitModule) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v ExplicitModule) hash(ctx fastnodectx.CallContext) FlatID {
...
// attr looks up an attribute on this values
func (v ExplicitType) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, v.Members, v.Base)
}

// equal determines whether this value is equal to another value
func (v ExplicitType) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a hash for this value, which is used during serialization
func (v ExplicitType) hash(ctx fastnodectx.CallContext) FlatID {
	// TODO(alex): this could collide if two funcs have the same path but one
	// is from the global graph and the other is from the local graph
...
// attr looks up an attribute on this values
func (v ExplicitFunc) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v ExplicitFunc) equal(ctx fastnodectx.CallContext, u Value) bool {
...
// hash gets a hash for this value, which is used during serialization
func (v ExplicitFunc) hash(ctx fastnodectx.CallContext) FlatID {
	// TODO(alex): this could collide if two funcs have the same path but one
	// is from the global graph and the other is from the local graph
...
// attr looks up an attribute on this values
func (v BoundMethod) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	return resolveAttr(ctx, name, v, nil, v.Type())
}

// equal determines whether this value is equal to another value
func (v BoundMethod) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v BoundMethod) hash(ctx fastnodectx.CallContext) FlatID {
