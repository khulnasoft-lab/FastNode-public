...
func (v SuperInstance) hash(ctx fastnodectx.CallContext) FlatID {
...
func (v SuperInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
...
func (v SuperInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
