...
func symAttrBases(ctx fastnodectx.CallContext, g pythonresource.Manager, sym pythonresource.Symbol, name string) []symAttrResult {
	if ctx.AtCallLimit() {
		return nil
	}
...
func resolveExternalSymAttrs(ctx fastnodectx.CallContext, ext External, name string) []symAttrResult {
