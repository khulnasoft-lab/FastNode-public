...
func (v TupleInstance) Elem() Value {
	return Unite(fastnodectx.TODO(), v.Elements...)
}
...
func (v TupleInstance) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch name {
	case "count":
...
func (v TupleInstance) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v TupleInstance) hash(ctx fastnodectx.CallContext) FlatID {
