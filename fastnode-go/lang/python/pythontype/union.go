...
func (v Union) Type() Value {
	...
	default:
		...
		return Unite(fastnodectx.TODO(), types...)
	}
}
...
func (v Union) Call(args Args) Value {
	...
	default:
		...
		return Unite(fastnodectx.TODO(), ret...)
	}
}
...
func (v Union) Elem() Value {
	...
	default:
		...
		return Unite(fastnodectx.TODO(), elts...)
	}
}
...
func (v Union) Index(index Value, allowValueMutation bool) Value {
	...
	default:
		...
		return Unite(fastnodectx.TODO(), idxs...)
	}
}
...
func (v Union) SetIndex(index Value, value Value, allowValueMutation bool) Value {
	...
	default:
		...
		return Unite(fastnodectx.TODO(), vs...)
	}
}

// attr gets the value of attributes on this object
func (v Union) attr(ctx fastnodectx.CallContext, name string) (AttrResult, error) {
	ctx.CheckAbort()
	switch len(v.Constituents) {
	case 0:
...
func (v Union) equal(ctx fastnodectx.CallContext, u Value) bool {
...
func (v Union) hash(ctx fastnodectx.CallContext) FlatID {
...
func DisjunctsNoCtx(v Value) []Value {
	return Disjuncts(fastnodectx.Background(), v)
}

// Disjuncts gets a list of disjuncts from a union type, none of which are themselves union types
func Disjuncts(ctx fastnodectx.Context, v Value) []Value {
	if v == nil {
		return nil
	}
...
func UniteNoCtx(vs ...Value) Value {
	return Unite(fastnodectx.Background(), vs...)
}

// Unite computes the union of several types, simplifying where possible
func Unite(ctx fastnodectx.Context, vs ...Value) Value {
	var val Value
	ctx.WithCallLimit(maxUnionDepth, func(ctx fastnodectx.CallContext) error {
...
func uniteImpl(ctx fastnodectx.CallContext, vs ...Value) Value {
	if ctx.AtCallLimit() {
		return nil
	}
	...
	addDisjunct := func(v Value) {
		...
		for _, other := range disjuncts {
			...
			case vType:
				if h1 == 0 {
					h1, err = Hash(fastnodectx.TODO(), v)
					if err != nil {
				...
				h2, err = Hash(fastnodectx.TODO(), other)
				if err != nil {
					// treat error hashing as not equal
					break
				}
	...
	if len(disjuncts) > maxUnionSize {
		sort.Slice(disjuncts, func(i, j int) bool {
			h1, _ := Hash(fastnodectx.TODO(), disjuncts[i])
			h2, _ := Hash(fastnodectx.TODO(), disjuncts[j])
			return h1 < h2
		})
...
func uniteProperties(ctx fastnodectx.CallContext, vs ...PropertyInstance) Value {
	var gets, sets []Value
	for _, v := range vs {
		if v.FGet != nil {
...
func uniteLists(ctx fastnodectx.CallContext, vs ...ListInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
	var elems []Value
...
func uniteDicts(ctx fastnodectx.CallContext, vs ...DictInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
...
func uniteDataFrames(ctx fastnodectx.CallContext, vs ...DataFrameInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
...
func uniteOrderedDicts(ctx fastnodectx.CallContext, vs ...OrderedDictInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
	var asDicts []DictInstance
...
func uniteSets(ctx fastnodectx.CallContext, vs ...SetInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
	var elems []Value
...
func uniteDefaultDicts(ctx fastnodectx.CallContext, vs ...DefaultDictInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
...
func uniteDeques(ctx fastnodectx.CallContext, vs ...DequeInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
	var elems []Value
...
func uniteCounters(ctx fastnodectx.CallContext, vs ...CounterInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
...
func uniteQuerySets(ctx fastnodectx.CallContext, vs ...QuerySetInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
	var elems []Value
...
func uniteQueues(ctx fastnodectx.CallContext, vs ...QueueInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
	var elems []Value
...
func uniteLifoQueues(ctx fastnodectx.CallContext, vs ...LifoQueueInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
	var elems []Value
...
func unitePriorityQueues(ctx fastnodectx.CallContext, vs ...PriorityQueueInstance) Value {
	if len(vs) == 1 {
		return vs[0]
	}
	var elems []Value
