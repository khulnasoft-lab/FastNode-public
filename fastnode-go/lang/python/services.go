...
func (s *Services) findDocumentation(ctx fastnodectx.Context, vb valueBundle, buf *bufferIndex) (*pythonlocal.Documentation, *response.PythonDocumentation) {
	ctx.CheckAbort()
	...
	for _, val := range pythontype.Disjuncts(fastnodectx.TODO(), val) {
