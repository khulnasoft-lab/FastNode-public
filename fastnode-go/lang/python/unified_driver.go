...
func NewUnifiedDriver(ids userids.IDs, filename string, python *Services, local localcode.Context, fastnodeLocal bool) *UnifiedDriver {
	scanOpts := pythonscanner.Options{
		ScanComments: true,
		ScanNewLines: true,
	}
...
func (d *UnifiedDriver) Callee(ctx fastnodectx.Context, cursor int64) (CalleeResult, int, error) {
	ctx.CheckAbort()
	...
	inputs, ok := func() (CalleeInputs, bool) {
		...
		if d.lastContext == nil {
			...
			// SEE: https://github.com/khulnasoft-lab/fastnode/blob/master/fastnode-go/client/internal/fastnodelocal/file_processor.go
...
func (d *UnifiedDriver) HandleEvent(ctx fastnodectx.Context, evt *event.Event) string {
	ctx.CheckAbort()
...
func (d *UnifiedDriver) parse(ctx fastnodectx.Context, evt *event.Event) *Context {
	ctx.CheckAbort()
	...
	// need second clause for cases in which fastnoded sent back
...
func (d *UnifiedDriver) handle(ctx fastnodectx.Context, evt *event.Event, pyctx *Context) {
	ctx.CheckAbort()
...
func (d *UnifiedDriver) renderAutosearchID(ctx fastnodectx.Context, pyctx *Context) string {
	ctx.CheckAbort()
	...
	// SEE: https://github.com/khulnasoft-lab/fastnode/issues/5082
	return d.editor.renderSymbolID(ctx, sbs[0]).String()
}

func (d *UnifiedDriver) recordMetrics(ctx fastnodectx.Context, pyctx *Context, evt *event.Event) {
