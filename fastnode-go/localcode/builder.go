...
type FileSystem interface {
	...
	Walk(ctx fastnodectx.Context, path string, walkFn WalkFunc) error
}
...
type BuilderFunc func(ctx fastnodectx.Context, params BuilderParams) (*BuilderResult, error)
...
func (fs LocalFileSystem) Walk(ctx fastnodectx.Context, root string, walkFn WalkFunc) error {
	fi, err := os.Stat(root)
	if err != nil {
...
func (fs LocalFileSystem) walk(ctx fastnodectx.Context, root string, info FileInfo, walkFn WalkFunc) error {
	if !info.IsDir {
