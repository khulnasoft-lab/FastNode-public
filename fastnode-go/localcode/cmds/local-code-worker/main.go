...
func main() {
	...
	workerOpts := localcode.WorkerOptions{
		...
		FileCacheRoot:       envutil.GetenvDefault("LOCAL_WORKER_CACHE_DIR", "/var/fastnode/localfiles"),
		FileCacheSizeMB:     envutil.GetenvDefaultInt("LOCAL_WORKER_CACHE_SIZE_MB", 10240),
		ArtifactCacheRoot:   envutil.GetenvDefault("LOCAL_WORKER_ARTIFACT_DIR", "/var/fastnode/localartifacts"),
