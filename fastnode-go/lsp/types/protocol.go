...
type CompletionItem struct {
	...
	/**
	 * Fastnode hint string
	 */
	FastnodeHint string `json:"hint"`
	/**
...
type ServerCapabilities = struct {
	...
	ExecuteCommandProvider ExecuteCommandOptions `json:"executeCommandProvider,omitempty"`
	/**
	 * Fastnode specific capabilities
	 */
	FastnodeProvider bool `json:"fastnodeProvider,omitempty"`
	/**
	 * Experimental server capabilities.
	 */
	Experimental interface{} `json:"experimental,omitempty"`
...
// Custom Fastnode Types
type FastnodeOnboardingParams struct {
	ServerRoot string `json:"serverRoot"`
}

type FastnodeSelectionParams struct {
	Positions    []Position             `json:"positions"`
	TextDocument TextDocumentIdentifier `json:"textDocument"`
	Text         string                 `json:"text"`
}

type FastnodeStatusParams struct {
	URI DocumentURI `json:"uri"`
}

type FastnodeTrackParams struct {
