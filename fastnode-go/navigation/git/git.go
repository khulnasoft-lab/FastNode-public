...
// Next ...
func (r *Repo) Next(ctx fastnodectx.Context) (Commit, error) {
	r.m.Lock()
	defer r.m.Unlock()
...
func (r *Repo) getCommit(ctx fastnodectx.Context, commit *object.Commit) (Commit, error) {
...
func processCommitFiles(ctx fastnodectx.Context, commit *object.Commit) []File {
