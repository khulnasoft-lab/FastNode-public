...
def main() -> None:
    args = parse_args()
    files = [
        "fastnode-go/navigation/recommend/recommend.go",
        "fastnode-go/client/internal/fastnodelocal/internal/navigation/manager.go",
        "fastnode-go/lang/language.go",
        "fastnode-go/client/internal/fastnodelocal/internal/completions/lexical.go",
        "fastnode-go/lang/lexical/lexicalcomplete/lexicalproviders/Data_inputs.go",
        "fastnode-go/lang/python/pythoncomplete/driver/mixing.go",
        "fastnode-go/lang/python/pythondocs/index.go",
    ]
    dirs = [
        "",
        "fastnode-go/client/internal",
        "fastnode-go",
        "fastnode-go/lang/python",
        "fastnode-golib",
        "fastnode-golib/lexicalv0",
        "fastnode-python",
    ]
...
def fmt_path(path: str) -> str:
    github = "https://github.com/khulnasoft-lab/fastnode/blob/master"
