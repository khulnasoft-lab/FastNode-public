...
class Logs extends React.Component {
  ...
  openGitHub = e => {
    e.preventDefault()
    electron.shell.openExternal('https://github.com/khulnasoft-lab/plugins/issues')
  }
      ...
      <div className="main__sub">
        <div className="logs">
          <div className="logs__section">
            ...
            <p>
              If you are experiencing issues with Fastnode, you can generate logs to
              help us debug. Your logs will be stored at a secure URL that can
              only be accessed by Fastnode.
            </p>
