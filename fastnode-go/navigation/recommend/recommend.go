...
type Recommender interface {
	Recommend(ctx fastnodectx.Context, request Request) ([]File, error)
	RecommendBlocks(ctx fastnodectx.Context, request BlockRequest) ([]File, error)
...
type Options struct {
	...
	// See fastnode-go/navigation/offline/experiments/underscores/README.md
...
// https://github.com/khulnasoft-lab/fastnode/blob/master/.gitignore#L1-L6
type Block struct {
...
func NewRecommender(ctx fastnodectx.Context, opts Options, i ignore.Ignorer, s git.Storage) (Recommender, error) {
...
func (r recommender) Recommend(ctx fastnodectx.Context, request Request) ([]File, error) {
...
func (r recommender) RecommendBlocks(ctx fastnodectx.Context, request BlockRequest) ([]File, error) {
	start := time.Now()
...
func (r recommender) recommendFiles(ctx fastnodectx.Context, currentID fileID, content string, request Request) ([]File, error) {
	start := time.Now()
