...
type XXXXXXXCompletion struct {
	...
	/*
		Display     string `json:"fastnode_display"`
		Hint        string `json:"fastnode_hint"`
		WebDocsLink string `json:"fastnode_web_docs_link"`
		Synopsis    string `json:"fastnode_synopsis"`
		Signature   string `json:"fastnode_signature"`
	*/
}
