...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/segment-analysis/internal/tracks"
...
func main() {
	...
	analyze.Analyze(uris, 4, "fastnode_status", func(meta analyze.Metadata, track *tracked) bool {
		if meta.EventName != "fastnode_status" {
			return true
		}
		platform := track.OS
