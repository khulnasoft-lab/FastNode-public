...
cd ~/go/src/github.com/khulnasoft-lab/fastnode/fastnode-go/stackoverflow/cmd/google-so-results
...
# fetch so pages
cd ~/go/src/github.com/khulnasoft-lab/fastnode/fastnode-go/stackoverflow/cmd/fetch-so-pages
