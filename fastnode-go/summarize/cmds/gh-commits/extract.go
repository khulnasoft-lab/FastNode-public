...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/summarize/filter"
	"github.com/khulnasoft-lab/fastnode/fastnode-golib/cmdline"
	"github.com/khulnasoft-lab/fastnode/fastnode-golib/githubcorpus"
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-golib/tarball"
...
func computePatch(from, to *object.Commit, maxChangesPerCommit int) *object.Patch {
	...
	for _, c := range changes {
		...
		if err != nil || (maxFileSize > 0 && fsz > maxFileSize) {
			...
			// e.g khulnasoft-lab/atom-plugin/atom-snippets-fork
			return nil
		}
