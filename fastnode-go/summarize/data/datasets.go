...
const (
	...
	// normalized to utf8.
	// SEE: khulnasoft-lab/local-pipelines/summarize/Makefile.datasets
	RawGHCommitsCrawl = "s3://fastnode-local-pipelines/gh-commits-all/2020-11-20/raw"

	// ShuffledGHCommitsCrawl is the shuffled version of RawGHCommitsCrawl.
	// SEE: khulnasoft-lab/local-pipelines/summarize/Makefile.datasets
	ShuffledGHCommitsCrawl = "s3://fastnode-local-pipelines/gh-commits-all/2020-11-20/shuffled"

	// SplitGHCommitsCrawlRoot is the split (train/validate/test) version of ShuffledGHCommitsCrawl.
	// SEE: khulnasoft-lab/local-pipelines/summarize/Makefile.datasets
	SplitGHCommitsCrawlRoot = "s3://fastnode-local-pipelines/gh-commits-all/2020-11-20/split"
)
