...
func main() {
	args := struct {
		...
		Tables:      "s3://fastnode-data/type-inference-models/2015-10-09_16-40-58-PM/", // original type induction tables
		ReturnTypes: "s3://fastnode-emr/datasets/curated-snippets/2016-09-16_14-47-16-PM/return-types.json.gz",
	}
	arg.MustParse(&args)
