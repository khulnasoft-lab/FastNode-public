...
const localMachineID = "fastnode_local"
...
// SetLocal enables using values specific to fastnode local
...
func (u *UserIDs) ForgetfulMetricsID() string {
	...
	// this behavior is duplicated in fastnode-go/client/internal/auth/remote.go
