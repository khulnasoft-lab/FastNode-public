...
func TestCachePath(t *testing.T) {
	...
	y := url.URL{Scheme: "s3", Host: "khulnasoft.com", Path: "foo.txt"}
	asserts.Equal("/var/fastnode/s3cache/khulnasoft.com/foo.txt", CachePath(&y))
}
...
func TestNewCachedS3Reader_CacheHit(t *testing.T) {
	...
	uri := "s3://fastnode-data/experiments/testdata/abc.txt"
	cachepath := filepath.Join(cacheroot, "fastnode-data/experiments/testdata/abc.txt")
