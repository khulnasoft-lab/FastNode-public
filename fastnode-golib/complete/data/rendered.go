...
type ReferentInfo struct {
	...
	WebID   string        `json:"web_id,omitempty"`   // https://khulnasoft.com/python/docs/<WebID>
	LocalID string        `json:"local_id,omitempty"` // understood by Fastnode Local
}
...
// AddSmartStar returns true if a star should be added to smart (Fastnode Pro) RCompletions
