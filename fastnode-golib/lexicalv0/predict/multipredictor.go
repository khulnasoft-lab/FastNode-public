...
// PredictChan ...
func (t *TFMultiPredictor) PredictChan(kctx fastnodectx.Context, in Inputs) (chan Predicted, chan error) {
...
func (t *TFMultiPredictor) Predict(kctx fastnodectx.Context, in Inputs) (Predictions, error) {
