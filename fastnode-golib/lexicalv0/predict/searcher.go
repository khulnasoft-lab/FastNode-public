...
type nextLogitsFn func(ctx fastnodectx.Context, step int, candidates [][]int64) ([][]float32, error)
...
func (s searcher) Search(ctx fastnodectx.Context) (Predictions, error) {
...
func (s searcher) step(ctx fastnodectx.Context, stepNum int, cands candidates) (candidates, Expansion, error) {
	ctx.CheckAbort()
...
func (s searcher) selectExtensions(ctx fastnodectx.Context, base candidates, bExts batchExts) (candidates, batchExts) {
	ctx.CheckAbort()
...
func (s searcher) selectCandidates(ctx fastnodectx.Context, cs candidates) candidates {
	ctx.CheckAbort()
...
func (s searcher) sample(ctx fastnodectx.Context, cs candidates, numSamples int) candidates {
	ctx.CheckAbort()
...
func (s searcher) allExpansions(ctx fastnodectx.Context, base candidates, batchExts batchExts) candidates {
	ctx.CheckAbort()
...
func (s searcher) filterByPrefix(ctx fastnodectx.Context, bExts batchExts) batchExts {
	ctx.CheckAbort()
...
func (s searcher) filterExts(ctx fastnodectx.Context, base candidates, bExts batchExts, filter func(candidates) candidates) (candidates, batchExts) {
	ctx.CheckAbort()
