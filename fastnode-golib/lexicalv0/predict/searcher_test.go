...
func TestFilterExts(t *testing.T) {
	...
	for _, tc := range tcs {
		actualBase, actualExts := searcher{strict: true}.filterExts(fastnodectx.Background(), tc.rawBase, tc.raw, tc.filter)
...
func TestFilterPreds(t *testing.T) {
	...
	for _, tc := range tcs {
		...
		actualExts := s.filterByPrefix(fastnodectx.Background(), tc.raw)
...
func TestAllExpansions(t *testing.T) {
	...
	for _, tc := range tcs {
		exps := searcher{strict: true}.allExpansions(fastnodectx.Background(), tc.base, tc.exts)
...
func TestSample(t *testing.T) {
	...
	for _, tc := range tcs {
		...
		actual := s.sample(fastnodectx.Background(), tc.raw, tc.numSamples)
...
func TestSelectCandidates(t *testing.T) {
	...
	for _, tc := range tcs {
		...
		selected := s.selectCandidates(fastnodectx.Background(), tc.raw)
