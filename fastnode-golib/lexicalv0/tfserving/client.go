...
func NewClient(serverURL, model string) (*Client, error) {
	parsedURL, err := fastnodeserver.ParseFastnodeServerURL(serverURL)
	if err != nil {
		return nil, err
	}
...
func (c *Client) SearchPrefixSuffix(kctx fastnodectx.Context, before, after, prefixIDs []int64) ([][]int64, [][]float32, error) {
...
func (c *Client) Search(kctx fastnodectx.Context, context, mask, prefixIDs []int64) ([][]int64, [][]float32, error) {
	inputs := c.searchPlaceholders(prefixIDs)
...
func (c *Client) search(kctx fastnodectx.Context, inputs map[string]*tf_proto.TensorProto) ([][]int64, [][]float32, error) {
