...
func doRequest(kctx fastnodectx.Context, client serving_proto.PredictionServiceClient, req *serving_proto.PredictRequest) (*serving_proto.PredictResponse, error) {
