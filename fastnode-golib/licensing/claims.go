...
// Version enumerates the Fastnode claims versions
type Version string
...
// Claims defines the attributes of a Fastnode license (encoded as JWT claims)
type Claims struct {
...
func (c Claims) Valid() error {
	...
	if c.Product == Free {
		return errors.Errorf("cannot issue license for Fastnode Free product")
	}
	return nil
}
