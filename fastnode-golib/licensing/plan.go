...
// Product enumerates the Fastnode products
type Product string
...
// Plan enumerates the Fastnode plans. Plans are associated with products.
type Plan string
...
const (
	...
	ProIndefinite   Plan = "pro_indefinite" // For sunsetting Fastnode. Is considered a subscription for fallback behavior.
	ProTrialMonthly Plan = "pro_trial_monthly"
	ProTrialYearly  Plan = "pro_trial_yearly"
	ProServer       Plan = "pro_server" // This plan is only used for Fastnode Server, and is not associated with real licenses.
