...
// MetadataKeyTrialDuration is the key used in BeanieFastnodeMetadata
const MetadataKeyTrialDuration = "fastnode_trial_duration"
...
// BeanieFastnodeMetadata defines metadata, which is used by Fastnode and passed on to Octobat
type BeanieFastnodeMetadata struct {
	FastnodeUserID        string `json:"fastnode_user_id,omitempty"`
	IPAddress         string `json:"ip_address,omitempty"`
	FastnodeTrialDuration int64  `json:"fastnode_trial_duration,omitempty"` //seconds
}
...
type BeanieServerlessSession struct {
	...
	Metadata          BeanieFastnodeMetadata `json:"metadata"`
...
type BeanieServerSession struct {
	...
	Metadata          *BeanieFastnodeMetadata `json:"metadata,omitempty"`
