...
// Client is an API to talk to Fastnode's custom Kinesis endpoint at t.khulnasoft.com
...
// NewCommonClient returns a new Fastnode client for t.khulnasoft.com, which is configured with the given source
...
// NewClient returns a new Fastnode client for t.khulnasoft.com, which is ready for production use
...
// newConfiguredClient returns a new Fastnode kinesis client, which is ready for production use
