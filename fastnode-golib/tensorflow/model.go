...
// sized is implemented in fastnode-golib/fileutil/filemap.go
...
// The Python fastnode_ml.fastnode.save.save_frozen_model() function should save models in this format, as well as
