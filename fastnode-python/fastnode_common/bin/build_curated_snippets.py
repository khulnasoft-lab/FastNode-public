...
from fastnode.codeexamples import extract
from fastnode.emr import io
...
if __name__ == "__main__":
    ...
    for _, curated_example in io.read(sys.stdin):
        ...
        try:
            ...
            # Replace curation variables (e.g $HTTP_PORT$) with fastnode_var
            code = re.sub('\${1}([a-zA-Z_]+)\${1}', 'fastnode_var', code)
