...
from fastnode.codeexamples.context import Context
from fastnode.codeexamples.context import node_to_type
from fastnode.codeexamples.context import is_literal
from fastnode.codeexamples.context import literal_value
...
class Incantation(object):
    ...
    def to_json(self):
        """
        This format corresponds to python.Incantation in fastnode-go/lang/python.
        """
        return {
...
class Snippet(object):
    ...
    def to_json(self):
        """
        This format corresponds to python.Snippet in fastnode-go/lang/python.
        """
