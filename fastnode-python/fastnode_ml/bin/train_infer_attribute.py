...
from fastnode.infer_attribute.data import DataFeeder, LabelTaxonomy
from fastnode.infer_attribute.model import GGNN, Config
...
TENSORBOARD_PATH = '/data/fastnode/tensorboard/' + MODEL_NAME
MODEL_SAVE_PATH = '/data/fastnode/models/' + MODEL_NAME
