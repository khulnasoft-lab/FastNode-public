...
def get_responses(responses_file: str, histories: pd.DataFrame) -> pd.DataFrame:
    ...
    :param responses_file: The original survey CSV file (as exported by Typeform)
        see https://fastnode.quip.com/DgfvAoP0WOma/Windows-User-Survey
    ...
    # for each respondent, we find the day of their first fastnode_status event, the day of their last fastnode_status event,
    ...
    with open(responses_file) as csvfile:
        ...
        for i, row in enumerate(reader):
            ...
            last_used_fastnode = {
                ...
                'the last 90 days': '90',
                'the last year': 'year',
                'I have never used Fastnode': 'never',
                '': '',
            }[last_used_fastnode]
            ...
            recs.append({
                ...
                'last_used_fastnode': last_used_fastnode,
                'recommend_fastnode': recommend_fastnode,
                'user_id': uid,
