class Constants(object):
    ...
    # refer to github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonscanner/token.go
    N_TOKENS = 104
    # number of keyword classes
    # refer to github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonkeyword/mappings.go
    ...
    # refer to github.com/khulnasoft-lab/fastnode/fastnode-go/lang/python/pythonkeyword/features.go
    N_REL_INDENT = 3
