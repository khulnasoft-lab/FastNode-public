from fastnode.pkgexploration.runtime import patch; REFMAP = patch()
...
from fastnode.pkgexploration.explore import Explorer
from fastnode.pkgexploration.dist import DistMeta
