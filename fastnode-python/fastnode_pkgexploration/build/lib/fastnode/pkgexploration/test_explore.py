...
def test_explore_example_references(runtime_refmap):
    ...
    graph = explore_and_link('fastnode.pkgexploration.examples.explore', runtime_refmap)

    assert graph['Test']['large']['@node']['reference'] == 'fastnode.pkgexploration.examples.runtime_helper.LARGE'
    assert graph['Test']['foo']['@node']['reference'] == 'fastnode.pkgexploration.examples.foo.Foo.foo'
    assert graph['Foo']['@node']['reference'] == 'fastnode.pkgexploration.examples.foo.Foo'
    assert graph['foo']['@type']['@node']['reference'] == 'fastnode.pkgexploration.examples.foo.Foo'
