...
class TypeutilsTest(unittest.TestCase):
    ...
    def test_approx_canonical_name_unboundmethod(self):
        self.assertEqual(reflectutils.approx_canonical_name(bar.Bar.foo), "fastnode.pkgexploration.examples.foo.Foo.foo")
        self.assertEqual(reflectutils.approx_canonical_name(foo.Foo.foo), "fastnode.pkgexploration.examples.foo.Foo.foo")
