...
def test_refmap(runtime_refmap):
    ...
    # assert runtime_refmap.lookup(runtime, runtime.PI) == 'fastnode.pkgexploration.examples.runtime_helper.PI'

    # test with module object
    assert runtime_refmap.lookup(runtime, runtime.LARGE) == 'fastnode.pkgexploration.examples.runtime_helper.LARGE'
    assert runtime_refmap.lookup(runtime, runtime.empty) == 'fastnode.pkgexploration.examples.runtime_helper.empty'
    # test with module path
    assert runtime_refmap.lookup(runtime.__name__, runtime.LARGE) == 'fastnode.pkgexploration.examples.runtime_helper.LARGE'
    # test with large int
