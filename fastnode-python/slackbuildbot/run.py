...
async def release(bot, items):  # pylint: disable=too-many-branches
    ...
    - `website`: website
    - `npm`: publish fastnode's npm package suite (fastnode-connector, fastnode-api, fastnode-installer)
...
async def upload_sitemaps(bot):
    """Generate and upload a new sitemap for khulnasoft.com
