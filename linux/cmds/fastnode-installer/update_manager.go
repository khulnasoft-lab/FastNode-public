...
func newUpdateManager() *updateManager {
	return &updateManager{
		metadataURL: "https://linux.khulnasoft.com/linux/fastnode-app/update-check",
		httpClient: &http.Client{
			Timeout: 0,
		},
	}
...
// downloadUpdate downloads the data of the given version of Fastnode and stores the file at targetFilePath
