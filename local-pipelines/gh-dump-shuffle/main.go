...
func main() {
	args := struct {
		...
		Input:      "s3://fastnode-local-pipelines/gh-dump-js/2019-11-19_12-02-10-AM/js/",
		Output:     "s3://fastnode-local-pipelines/gh-dump-js-shuffled/2020-01-13_10-30-09-AM/js/",
