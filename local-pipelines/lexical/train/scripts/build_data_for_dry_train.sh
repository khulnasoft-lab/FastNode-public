...
go build -o tmp_dry_run/rundb github.com/khulnasoft-lab/fastnode/fastnode-golib/pipeline/cmds/rundb
go build -o tmp_dry_run/datagen github.com/khulnasoft-lab/fastnode/local-pipelines/lexical/train/cmds/datagen
