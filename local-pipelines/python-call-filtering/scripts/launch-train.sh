...
cd /var/fastnode/bundle/khulnasoft-lab/local-pipelines/python-call-filtering
...
azure-cluster bundle $BUNDLE_FILE $TMP_DIR/call-filtering-run.sh --fastnode-ml \
    --go-binary github.com/khulnasoft-lab/fastnode/fastnode-golib/pipeline/cmds/rundb \
    --go-binary github.com/khulnasoft-lab/fastnode/local-pipelines/python-call-filtering/python-call-prob/traindata \
    --go-binary github.com/khulnasoft-lab/fastnode/local-pipelines/python-call-filtering/gtdata \
    --go-binary github.com/khulnasoft-lab/fastnode/local-pipelines/python-call-filtering/threshold \
    --khulnasoft-lab-path local-pipelines/python-call-filtering/python-call-prob/train/train.py \
    --khulnasoft-lab-path local-pipelines/python-call-filtering/Makefile.cluster
