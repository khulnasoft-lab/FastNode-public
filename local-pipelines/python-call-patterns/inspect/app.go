...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-golib/diskmapindex"

	"github.com/khulnasoft-lab/fastnode/local-pipelines/python-call-patterns/internal/data"
)
...
func (a *app) HandleSearch(w http.ResponseWriter, r *http.Request) {
	...
	syms, err := a.rm.PathSymbols(fastnodectx.Background(), pythonimports.NewDottedPath(query))
	if err != nil {
