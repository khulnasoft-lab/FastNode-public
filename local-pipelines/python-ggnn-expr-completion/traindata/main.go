...
func main() {
	...
	args := struct {
		...
		Packages: "~/go/src/github.com/khulnasoft-lab/fastnode/local-pipelines/python-ggnn-call-completion/packagelist.txt",
		Endpoint: "http://ml-training-0.khulnasoft.com:3039/symbol/scores",
	}
