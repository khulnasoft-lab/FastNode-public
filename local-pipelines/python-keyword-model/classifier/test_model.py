...
from fastnode.infer_keyword import Config, KeywordModelEncoder, Model, TrainInputs
from fastnode.utils.save import save_model, save_frozen_model, load_frozen_model

from fastnode.infer_keyword.data import Batch, Dataset



model_path = "/data/fastnode/keywords_model/out/tmp/keyword_model.frozen.pb"
dataset_path = "/data/fastnode/keywords_model/out/comparison_data.json"
...
def main():
    ...
    with open("/data/fastnode/keywords_model/result_python.json", "w") as outfile:
