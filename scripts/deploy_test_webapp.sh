...
REACT_APP_TEST_BACKEND="${REACT_APP_TEST_BACKEND:-https://staging.khulnasoft.com}"

TESTING_BUCKET=web-dev.khulnasoft.com

DISTRIBUTION_ID=XXXXXXX

REGION=us-west-1

rm -rf $KHULNASOFT-LAB/web/app/build
