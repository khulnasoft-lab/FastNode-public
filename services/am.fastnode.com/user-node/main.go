...
import (
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/community/student"
	"go.uber.org/zap"

	"github.com/khulnasoft-lab/fastnode/fastnode-golib/gkeutil"
	...
	"github.com/khulnasoft-lab/fastnode/fastnode-go/capture"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/clientlogs"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/community"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/community/account"
	"github.com/khulnasoft-lab/fastnode/fastnode-go/health"
...
var validHosts = [...]string{"www.khulnasoft.com", "XXXXXXX"}

// Our origin validator will allow any origin thats HTTPS and in the
// khulnasoft.com domain. This should become a whitelist of hostnames to mitigate
