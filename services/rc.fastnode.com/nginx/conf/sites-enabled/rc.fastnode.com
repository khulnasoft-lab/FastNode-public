...
upstream XXXXXXX.khulnasoft.com {
  server XXXXXXX.khulnasoft.com:443 max_fails=0;
  keepalive 256;
}
...
server {
  ...
  location = /internal/auth {
    resolver 8.8.8.8;
    proxy_pass https://XXXXXXX.khulnasoft.com/require-auth?ID=$nchan_channel_id;
