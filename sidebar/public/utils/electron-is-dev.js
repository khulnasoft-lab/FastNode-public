...
const notFastnodeElectronPath = () => {
  return !/[\\/]osx[\\/]electron[\\/]Fastnode[.]app[\\/]/.test(process.execPath) &&
...
module.exports = {
  isDev: getFromEnv() || process.defaultApp || /[\\/]electron-prebuilt[\\/]/.test(process.execPath) || notFastnodeElectronPath(),
