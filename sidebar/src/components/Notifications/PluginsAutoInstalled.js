  ...
  <div className="notifications__plugins">
    ...
    <div className="notifications__plugins__content">
      <div className="notifications__plugins__p">
        Fastnode has installed plugins for &nbsp;{ uniqueIDs(pluginIDs).map( (pluginID, index, data) => <span key={pluginID}>
        ...
        .
        <br/>
        Please restart your editors to activate Fastnode. <Link className="notifications__plugins__a--bold" to="/settings/plugins" onClick={dismiss}>Undo</Link>.
      </div>
    </div>
  </div>
