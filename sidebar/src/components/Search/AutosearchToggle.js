  ...
  render() {
    ...
    return <div>
      ...
      { tooltipEnabled && <div className="search__auto-search__modal">
        ...
        <h4 className="search__auto-search__modal_title">{ enabled ? "Fastnode Python docs are following your cursor" : "Fastnode Python docs are not followng your cursor" }</h4>
        <p className="search__auto-search__modal_description">
          { enabled ?
            "Fastnode is following your typing and showing relevant Python docs. Click to disable. Set the default in settings. Fastnode only provides docs for Python." :
            "Click to allow Fastnode to follow your cursor and automatically search for identifiers while you code. Set the default in settings. Fastnode only provides docs for Python."
          }
        </p>
      </div>
      }
