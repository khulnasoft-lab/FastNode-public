...
class Done extends React.Component {
  ...
  render() {
    return <div className="setup__done showup__animation">
      <h2 className="setup__title">Fastnode is ready!</h2>
      <p className="setup__text">
        <span>Welcome to the future of programming.</span>
        <br/><br/>
        <span>Restart your editor to activate Fastnode. If you haven’t installed the Fastnode plugin yet, you can do so from settings.</span>
      </p>
      { this.props.system && this.props.system.os !== "linux" &&
        ...
        >
          <p className="setup__text">Show the Fastnode icon in your&nbsp;
      ...
      >
        <p className="setup__text">Automatically integrate Fastnode when new editors are installed</p>
      </SettingsCheckbox>
