...
import * as fastnodeProtocol from '../actions/fastnode-protocol'
...
import FastnodedWaiter from './FastnodedWaiter'
...
class App extends React.Component {
  ...
  componentDidUpdate() {
    ...
    const notWorking = fastnodeNotWorking(errors, polling)
    ...
    if (notWorking) {
      if (!errors.online) {
        ...
        //connection wise on our (fastnoded) end
        if (navigator.onLine) {
    ...
    return (
      ...
      >
        <FastnodedWaiter>
          <StatePoller />
          <ThirdPartyScripts />
          <AppErrors reloadHandler={this.reloadFastnode} />
...
const mapDispatchToProps = dispatch => ({
  ...
  addRoute: (route) => dispatch(fastnodeProtocol.addRoute(route)),
  ...
  getFastnodedStatus: () => dispatch(polling.getFastnodedStatus()),
