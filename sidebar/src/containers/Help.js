        ...
        <div className="wrapper-page">
          ...
          <div className="help__body">
            ...
            <LinkedAnimBanner
              ...
              href="https://github.com/khulnasoft-lab/plugins/issues"
              delay={1}
            />
            <LinkedAnimBanner
            ...
            />
            <LinkedAnimBanner
              child={ <div className="help__banner__text">Share Fastnode</div> }
...
function getRateLink(mruEditor) {
  let rateLink = "https://github.com/khulnasoft-lab/plugins"

  switch (true) {
    case mruEditor.toLowerCase().includes("vscode"):
      rateLink = "https://marketplace.visualstudio.com/items?itemName=khulnasoft-lab.fastnode&ssr=false#review-details"
      break
    case mruEditor.toLowerCase().includes("atom"):
      rateLink = "https://github.com/khulnasoft-lab/atom-plugin"
      break
    case mruEditor.toLowerCase().includes("sublime"):
      rateLink = "https://github.com/khulnasoft-lab/FastnodeSublime"
      break
    case mruEditor.toLowerCase().includes("vim"):
      rateLink = "https://github.com/khulnasoft-lab/vim-plugin"
      break
    default:
      break
  }
