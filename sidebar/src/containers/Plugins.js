        ...
        <div className="plugins">
          ...
          <div ref={this.pluginsList} className="plugins__list">
            ...
            { !this.state.loading && installed_editors.length === 0 &&
              <p> We could not find any supported editors on your system. If this is an error, please <a rel="noopener noreferrer" target="_blank" href="https://github.com/khulnasoft-lab/issue-tracker">report it</a>.</p>
            }
...
class UninstalledEditor extends React.Component {
  constructor(props) {
    ...
    this.urls = {
      'atom': 'https://github.com/khulnasoft-lab/atom-plugin#installing-the-fastnode-assistant-for-atom',
      'intellij': `https://${Domains.Help}/article/62-managing-editor-plugins#custom-installations`,
      'sublime3': 'https://github.com/khulnasoft-lab/FastnodeSublime#installing-the-fastnode-assistant-for-sublime',
      'vscode': 'https://github.com/khulnasoft-lab/vscode-plugin#installing-the-fastnode-assistant-for-visual-studio-code',
      'spyder': `https://${Domains.Help}/article/123-fastnode-cannot-detect-spyder-installation`,
    }
  }
  ...
  render() {
    ...
    return <div className={`plugins__plugin plugins__plugin--expanded-false`}>
      ...
      {!this.state.expanded &&
        <span><p>Fastnode could not automatically detect {name}. If you have {name} installed, <a onClick={this.expand}>fix this</a>.</p></span>}

      {this.state.expanded &&
        <span>
          <p>Fastnode could not automatically detect {name}.</p>
...
class JupyterLab extends React.Component {
  render() {
    return (
      <div>
        <p>
          Fastnode supports JupyterLab v2.2 and above.
          See our <a href="https://github.com/khulnasoft-lab/jupyterlab-fastnode#installing-the-fastnode-extension-for-jupyterlab" target="_blank">installation guide</a> for more info.
        </p>
      </div>
    )
  }
    ...
    { running && !mustClose && requires_restart &&
        <div className="plugins__note">
          {installed
            ...
            : `You may need to restart ${name} after installing for Fastnode to activate.`
          }
        </div>
    }
    { id === "spyder" && !mustClose && !installed &&
        <p className="plugins__also">
          Fastnode will automatically update Spyder's autocompletions settings so that they are optimized to work with Fastnode.
