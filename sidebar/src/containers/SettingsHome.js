...
import FastnodeServerInput from '../components/FastnodeServerInput'
      ...
      <div className="main__sub">
        <div className="home">
          ...
          <div className="home__section">
            ...
            >
              <p>Automatically install the Fastnode plugin for all supported editors</p>
            </SettingsCheckbox>
            ...
            <MultiwordInFastnodeFreeCheckbox
            ...
            <React.Fragment>
              ...
              >
                <p>Disable all completions from Fastnode</p>
              </SettingsCheckbox>
            </React.Fragment>
            ...
            <React.Fragment>
              ...
              </SettingsCheckbox>
              {
                ...
                <p className="home__disclaimer"><span
                  ...
                  onClick={this.restartFastnode}>
                  Restart Fastnode</span> for this to take effect</p>
              }
            </React.Fragment>
            ...
            <React.Fragment>
              ...
              >
                <p>Fastnode automatically starts on boot</p>
              </SettingsCheckbox>
            </React.Fragment>
...
function MultiwordInFastnodeFreeCheckbox({
  conversionCohort,
  licenseInfo,
  ...
  return (
    ...
    >
      <p>Show multi-word completions in Fastnode Free</p>
    </SettingsCheckbox>
  )
}
...
const CustomProxy = ({ className, onChange, disabled, protocol, hostname, port, isValid }) => <div className={className}>
  ...
  {isValid && <span className="home__proxy__state" title="Your proxy settings are complete and applied to Fastnode">✓</span>}
</div>
