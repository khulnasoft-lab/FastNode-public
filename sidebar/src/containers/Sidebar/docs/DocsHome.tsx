  ...
  return (
    <div className="docs-page__root">
      <h4 className="showup__animation">
        Welcome to the Fastnode Copilot! <div className="docs-page__root__welcome-graphic"/>
      </h4>
      ...
      <div className="docs-page__root__hint docs-page__root__hint--python-logo showup__animation showup__animation--delay">
        ...
        <div>
          Fastnode also suggests Python completions as you code in your editor.
        </div>
      </div>
      ...
      <div className="docs-page__hint-container showup__animation showup__animation--delay-2">
        <div className="docs-page__root__hint docs-page__root__hint--javascript-logo">
          Fastnode can suggest completions inside your editor for many other languages. Hover your mouse over the language icons to see what file types Fastnode supports.
        </div>
...
const contentFromLang = {
  [Langs.Javascript]: {
    ...
    hover: {
      title: 'Javascript',
      msg: 'Fastnode provides completions in .js, .jsx, .ts, .tsx, and .vue files. Fastnode does not have documentation for these files.',
    },
  },
  [Langs.HTML]: {
    icon: {
    ...
    hover: {
      title: 'HTML & CSS',
      msg: 'Fastnode provides completions in .html, .css, and .less files. Fastnode does not have documentation for these files.',
    },
  },
  [Langs.Java]: {
    icon: {
    ...
    hover: {
      title: 'Java',
      msg: 'Fastnode provides completions in .java, .kt, and .scala files. Fastnode does not have documentation for these files.',
    },
  },
  [Langs.C]: {
    icon: {
    ...
    hover: {
      ...
      msg: 'Fastnode provides completions in .c, .cc, .cpp, .cs, .h, .hpp, and .m files. Fastnode does not have documentation for these files.',
    },
  },
  [Langs.Go]: {
    icon: {
    ...
    hover: {
      title: 'Go',
      msg: 'Fastnode provides completions in .go files. Fastnode does not have documentation for these files.',
    },
  },
}
