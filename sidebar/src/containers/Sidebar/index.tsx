...
class Sidebar extends React.Component<SidebarProps> {
  componentDidMount() {
    ...
    if (setupCompleted === true || setupCompleted === 'true') {
      ...
      // out while we launch Fastnode Pro...
      //
    ...
    return <div className={`main docs ${this.props.shouldBlur ? 'main--blur' : ''}`}>
      ...
      <div className="sidebar__tray">
        ...
        <div className="sidebar__pages">
          ...
          <TrayTooltip
            text="The software behind Fastnode has been acquired by another company. In this period of transition, you can continue to use any Fastnode software you possess, but neither we nor the new owner will be offering the software for download or supporting it at this time. We will explore new paths forward for our users to come. Thank you for your support of Fastnode, and please stay tuned for updates!"
