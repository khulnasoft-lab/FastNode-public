...
const settings = (state = defaultState, action) => {
  switch (action.type) {
    ...
    case actions.GET_PROXY_URL:
      return { ...state, proxyMode: action.data }
    case actions.GET_FASTNODE_SERVER_URL:
      return { ...state, enterpriseServerURL: action.data }
    case actions.GET_FASTNODE_SERVER_STATUS:
      return { ...state, fastnodeServerAvailable: action.data.available }
