...
import { localhostProxy, fastnodedStatusPath } from '../utils/urls'
...
//TODO: still need a better definitional version of health for fastnoded wrt how it interacts with clients
// of it
export const ignoreUrlForResponseCode = (resp) => {
  return resp.response.status < 500 || (resp.response.url && !resp.response.url.includes(fastnodedStatusPath()))
}
...
export const authFetch = ({ url, options={}}) =>
  fetch(
    ...
    // promise when fastnode is unreachable, instead we get a 500 error with
