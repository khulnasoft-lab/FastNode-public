...
export const fastnodedReadyPath = () => {
  return '/clientapi/fastnoded_online'
}
...
export const fastnodedStatusPath = () => {
...
export const hasSeenFastnodeLocalPath = () => {
  return '/clientapi/settings/has_seen_fastnode_local'
}
...
export const fastnodeServerURLPath = () => {
  return '/clientapi/settings/fastnode_enterprise_server'
}

export const fastnodeServerStatusPath = () => {
  return '/clientapi/settings/fastnode_enterprise_server/status'
}
