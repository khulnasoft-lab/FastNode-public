      ...
      <div className="footer__menu homepage__flex__wrapper">
        ...
        <div className="footer__section">
          ...
          <div className="footer__social">
            <a target="_blank" className="footer__social-item footer__twitter" href="https://twitter.com/fastnodehq" alt="twitter" rel="noopener noreferrer"> </a>
            <a target="_blank" className="footer__social-item footer__facebook" href="https://www.facebook.com/Fastnode-878570708838455/" alt="facebook" rel="noopener noreferrer"> </a>
            <a target="_blank" className="footer__social-item footer__linkedin" href="https://www.linkedin.com/company/fastnode-co-/" alt="linkedin" rel="noopener noreferrer"> </a>
          ...
          <p className="footer__text">Get Fastnode updates &amp; coding tips</p>
          <Newsletter/>
        </div>
      </div>
