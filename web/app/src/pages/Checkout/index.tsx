...
import fastnodeIntellisense from './images/fastnode-intellisense.jpg';
...
class Checkout extends React.Component<IComponentProps, IComponentState> {
  ...
  async canCheckout(): Promise<boolean> {
    ...
    this.showErrorMessage(
      `This account already has a Fastnode Pro license. Please log into Fastnode on your desktop to access Pro features.`
    );
    return false;
  }
  ...
  getTaxAmount(): number {
    ...
    const amountToTax: number = this.getDiscountedAmount(this.getFastnodeProPricing());
  ...
  getTotalBillingAmount(): number {
    const total: number = this.getDiscountedAmount(this.getFastnodeProPricing()) + this.getTaxAmount();
  ...
  render(): JSX.Element {
          ...
          <div className={styles['bill-calculation']}>
            <table>
              <tbody>
                <tr>
                  <td>Fastnode Pro</td>
                  <td>${this.getFastnodeProPricing().toFixed(2)}</td>
                </tr>
                {
                  this.state.coupon &&
                  <tr className="coupon-discount">
                    <td>Discounted</td>
                    <td>-${this.getOffAmount(this.getFastnodeProPricing())?.toFixed(2)}</td>
                  </tr>
                }
                {
            ...
            <Paragraph className={styles['bill-desc']}>
              ...
              {this.isAnnualBillingCycleSelected() ? ' yearly' : ' monthly'} until you cancel your Fastnode Pro
              subscription.
              <br /><br />
    ...
    return (
      <BasicLayout>
        <section className="container fastnode-pro-checkout">
          <Title className={styles['page-title']} level={1}> Fastnode Pro Checkout </Title>

          {
            ...
            <div ref={this.pageErrorsRef} className="page-error">
              ...
              <p className="desc">
                {this.state.paymentErrMessage}
                <br />
                For assistance on payment related errors, please contact your payment provider. For Fastnode related errors, please email 
          ...
          <Row className={styles['checkout-content']} justify="space-between">
                ...
                <li className={styles['checkout-step']}>
...

                  {
                    ...
                    <Paragraph className={styles['step-desc']}>
                      The Fastnode Pro subscription will be unlocked for <Text strong>{this.state.loggedInUser?.email}</Text>
                      <br />
            ...
            <Col md={24} lg={10}>
              ...
              <div className={styles['fastnode-pro-detail']}>
                <Title className={styles['fastnode-pro-title']} level={3}> WHAT’S INCLUDED WITH FASTNODE PRO? </Title>
                <img src={fastnodeIntellisense} alt="Fastnode Powered Intellisense" />
                <ul className={styles['fastnode-pro-features']}>
