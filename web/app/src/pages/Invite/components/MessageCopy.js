  ...
  render() {
    ...
    return <div className={`invite__link${className ? ` ${className}` : ''}`}>
      <textarea
        ...
        value={messageValue || `I've been using Fastnode, an AI-powered autocompletions engine for Python & JavaScript, to boost my productivity. You can get it for free at https://${Domains.PrimaryHost}.\r\n\r\nCheck it out in action! https://giphy.com/gifs/python-fastnode-Y4c5RiOeUGfcX4mgee`}
        readOnly
      ...
      <div className="invite__code__input">
        {messageBlock ||
          <div>
            I've been using Fastnode, an AI-powered autocompletions engine for Python & JavaScript, to boost my productivity. You can get it for free at https://{Domains.PrimaryHost}. <br/><br/>
