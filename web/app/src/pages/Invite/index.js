    ...
    return (
      <div className="invite-wrapper">
        ...
        <div className="invite">
          <Helmet>
            <title>Invite friends and coworkers to Fastnode!</title>
          </Helmet>
          ...
          <div className="invite__options invite__appear">
            ...
            <div className="invite-option">
              ...
              <TwitterLink
                ...
                className="invite__options__button"
                message={`Fastnode is the best autocompletions engine available for Python, powered by AI. Check it out — It's free! https://${Domains.PrimaryHost} @fastnodehq`}
              >
              ...
              { showSlackMessage ?
                <div className="invite__code invite__appear">
                  ...
                  <MessageCopy
                    ...
                    messageBlock={
                      <div>
                        Hey team! I've been using Fastnode, an AI-powered autocompletions engine for Python & JavaScript, to boost my productivity. You can get it for free at https://{Domains.PrimaryHost}.
                        <br/><br/>
                        Check it out in action!
                        https://giphy.com/gifs/python-fastnode-Y4c5RiOeUGfcX4mgee
                      </div>
                    }
                    messageValue={`Hey team! I've been using Fastnode, an AI-powered autocompletions engine for Python & JavaScript, to boost my productivity. You can get it for free at https://${Domains.PrimaryHost}.
...
https://giphy.com/gifs/python-fastnode-Y4c5RiOeUGfcX4mgee`}
            ...
            <div className="invite-option">
              {showTextCopy ?
                <div className="invite__code invite__appear">
                  <p className="invite__top-text">Share Fastnode</p>
                  <MessageCopy
                    eventPlace='share button'
                    buttonText="Copy Message"
                    buttonTextCopied="Message Copied - Share Fastnode Now!"
                  />
                </div> :
                <div
