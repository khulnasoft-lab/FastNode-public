    ...
    if (isProSubscriber === undefined || licenseInfo === undefined) {
      ...
      licenseBody = (
        <p>
          ...
          <a href="#" onClick={this.cancel}>
            Cancel your Fastnode Pro subscription.
          </a>
        </p>
      )
      ...
      switch (licenseInfo.plan) {
        case Plan.Trial:
          licenseBody = (
            <p>
              Your Fastnode Pro trial will end in {licenseInfo.days_remaining} days.
              {' '}
              <a href={`https://${Domains.WWW}/pro`}>
                Subscribe now!
              </a>
        ...
        case Plan.Temp:
          licenseBody = (
            <p>
              Your Fastnode Pro payment is still pending.
              {' '}
              <a href={`mailto:${Emails.Feedback}`}>
        ...
        case Plan.Education:
          licenseBody = (
            <p>
              Your Fastnode Pro educational subscription is on us!
        ...
        default:
          licenseBody = (
            <p>
              Your Fastnode Pro subscription is no longer active,
