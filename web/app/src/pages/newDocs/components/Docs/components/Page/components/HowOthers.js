...
const HowOthers = ({ patterns }) => {
  return (
    <section className='how-others-used-this'>
      ...
      <div className='hint'>
        Fastnode uses machine learning to show you common signatures. {/* Put back in when we have better link... <a href='https://help.khulnasoft.com/article/56-python' target='_blank'>Tell me more</a> */}
      </div>
    </section>
  )
}
