...
import './themes/fastnode-dark.css';
import './themes/fastnode-light.css';
...
class EditorSandbox extends React.Component {
  ...
  componentDidMount() {
    ...
    const detachmentHandler = () => {
      const wpWrapperEl = document.getElementById('fastnode-web-sandbox')
      ...
      /* restore onVisibility */
        ...
        >
          ...
          <CodeMirror
            options={{
              mode: 'python',
              theme: this.props.theme || 'fastnode-dark',
              lineNumbers: true,
              readOnly: false,
