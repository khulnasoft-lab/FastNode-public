...
const getLastCompletionText = (lastCompletion="a line") => `Wow. I just test drove Line-of-Code Completions from Fastnode and it completed \`${lastCompletion}\` for me in one go. This is mind-blowing. 🤯  Try it out in your browser.`
...
class SandboxSocialSharing extends React.Component {
  constructor(props) {
    ...
    let sharingText = props.lastCompletion
      ...
      : "Wow. I just test drove Line-of-Code Completions from Fastnode. This is mind-blowing. 🤯 Try it out in your browser."
  ...
  componentDidUpdate(prevProps) {
    ...
    if(!this.state.userHasEditedSharingText && prevProps.lastCompletion !== this.props.lastCompletion) {
      if(!this.props.lastCompletion) {
        this.setState({ sharingText:  "Wow. I just test drove Line-of-Code Completions from Fastnode. This is mind-blowing. 🤯 Try it out in your browser." })
      }
