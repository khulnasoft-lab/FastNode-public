...
export const scripts = {
  [TAB_NUMERICS]: {
    script: [
      // {
      //   type: TYPE_CHARS,
      //   sequence: '# Let\'s plot a graph using Fastnode\'s completions to speed up our development time\n\n# Start by importing the usual suspects\n',
      //   [AMOUNT]: 5
      // },
      // {
      //   type: TYPE_PAUSE
      ...
      },
      {
        ...
        cursorCaption: 'Whoa — Fastnode knows I want to call “plot”, and which arguments to pass in.\n\nWith one keystroke, Fastnode’s Line-of-Code Completions save me typing and keep me in flow',
        cursorCaptionPlacement: RIGHT_CURSOR_CAPTION_PLACEMENT,
        marginTop: -1,
        marginLeft: -20,
      ...
      },
      {
        ...
        complete: 'e(title)',
        finalSelectionWait: 2000,
        cursorCaption: "Fastnode knows which variable fits here.",
        cursorCaptionPlacement: RIGHT_CURSOR_CAPTION_PLACEMENT,
        marginLeft: -40,
      },
      {
      ...
      },
      {
        ...
        cursorCaption: "Once again Fastnode's AI helps me jump several steps ahead.",
        cursorCaptionPlacement: RIGHT_CURSOR_CAPTION_PLACEMENT,
        marginLeft: -20,
      },
      {
