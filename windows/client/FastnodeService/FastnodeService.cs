...
namespace FastnodeService {
    ...
    public partial class FastnodeService : ServiceBase {

        internal static readonly string PermanentRegistryPath = @"Software\Fastnode";
        internal static readonly string PerInstallationRegistryPath = @"Software\Fastnode\AppData";

        public FastnodeService() {
            InitializeComponent();
        }
        ...
        protected override void OnStop() {
            Log.LogMessage("FastnodeService stopping");
        }

        private void StartupForReal(object unusedState) {
            // note: the installer starts the service and fastnoded.exe simultaneously.
            ...
            Log.LogMessage(string.Format("FastnodeService started (MachineID is {0})", machineID));

            // Watches fastnoded process and handles crash reporting
