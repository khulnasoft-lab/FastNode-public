...
namespace FastnodeUpdateSignerCmd {
    struct BuildParams
    {
    ...
    static class Program {
        ...
        private static BuildParams buildParams()
        {
            ...
            var prevRelease = patchUpdaterFilename.Substring("FastnodePatchUpdater".Length,
            ...
            bp.DownloadURL = String.Format("https://windows.khulnasoft.com/windows/{0}/{1}", targetBuild, patchUpdaterFilename);
